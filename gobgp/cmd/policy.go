...
func formatDefinedSet(head bool, typ string, indent int, list []table.DefinedSet) string {    fmt.Printf("DEJDEJ id:",3673)
...
func showDefinedSet(v string, args []string) error {    fmt.Printf("DEJDEJ id:",3674)
...
func parsePrefixSet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3675)
...
func parseNeighborSet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3676)
...
func parseAsPathSet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3677)
...
func parseCommunitySet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3678)
...
func parseExtCommunitySet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3679)
...
func parseLargeCommunitySet(args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3680)
...
func parseDefinedSet(settype string, args []string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",3681)
...
func modDefinedSet(settype string, modtype string, args []string) error {    fmt.Printf("DEJDEJ id:",3682)
...
func printStatement(indent int, s *table.Statement) {    fmt.Printf("DEJDEJ id:",3683)
...
func printPolicy(indent int, pd *table.Policy) {    fmt.Printf("DEJDEJ id:",3684)
...
func showPolicy(args []string) error {    fmt.Printf("DEJDEJ id:",3685)
...
func showStatement(args []string) error {    fmt.Printf("DEJDEJ id:",3686)
...
func modStatement(op string, args []string) error {    fmt.Printf("DEJDEJ id:",3687)
...
func modCondition(name, op string, args []string) error {    fmt.Printf("DEJDEJ id:",3688)
...
func modAction(name, op string, args []string) error {    fmt.Printf("DEJDEJ id:",3689)
...
func modPolicy(modtype string, args []string) error {    fmt.Printf("DEJDEJ id:",3690)
...
func NewPolicyCmd() *cobra.Command {    fmt.Printf("DEJDEJ id:",3691)
