...
func updateColumnWidth(nlri, nexthop, aspath, label string) {    fmt.Printf("DEJDEJ id:",3593)
...
func getNeighbors(vrf string) (neighbors, error) {    fmt.Printf("DEJDEJ id:",3594)
...
func getASN(p *config.Neighbor) string {    fmt.Printf("DEJDEJ id:",3595)
...
func showNeighbors(vrf string) error {    fmt.Printf("DEJDEJ id:",3596)
...
func showNeighbor(args []string) error {    fmt.Printf("DEJDEJ id:",3597)
...
func getPathSymbolString(p *table.Path, idx int, showBest bool) string {    fmt.Printf("DEJDEJ id:",3598)
...
func getPathAttributeString(p *table.Path) string {    fmt.Printf("DEJDEJ id:",3599)
...
func makeShowRouteArgs(p *table.Path, idx int, now time.Time, showAge, showBest, showLabel bool, showIdentifier bgp.BGPAddPathMode) []interface{    fmt.Printf("DEJDEJ id:",3600)
...
func showRoute(destinationList [][]*table.Path, showAge, showBest, showLabel bool, showIdentifier bgp.BGPAddPathMode) {    fmt.Printf("DEJDEJ id:",3601)
...
func checkOriginAsWasNotShown(p *table.Path, shownAs map[uint32]struct{    fmt.Printf("DEJDEJ id:",3602)
}) bool {    fmt.Printf("DEJDEJ id:",3602)
...
func showValidationInfo(p *table.Path, shownAs map[uint32]struct{    fmt.Printf("DEJDEJ id:",3603)
}) error {    fmt.Printf("DEJDEJ id:",3603)
...
func showRibInfo(r, name string) error {    fmt.Printf("DEJDEJ id:",3604)
...
func parseCIDRorIP(str string) (net.IP, *net.IPNet, error) {    fmt.Printf("DEJDEJ id:",3605)
...
func showNeighborRib(r string, name string, args []string) error {    fmt.Printf("DEJDEJ id:",3606)
...
func resetNeighbor(cmd string, remoteIP string, args []string) error {    fmt.Printf("DEJDEJ id:",3607)
...
func stateChangeNeighbor(cmd string, remoteIP string, args []string) error {    fmt.Printf("DEJDEJ id:",3608)
...
func showNeighborPolicy(remoteIP, policyType string, indent int) error {    fmt.Printf("DEJDEJ id:",3609)
...
func extractDefaultAction(args []string) ([]string, table.RouteType, error) {    fmt.Printf("DEJDEJ id:",3610)
...
func modNeighborPolicy(remoteIP, policyType, cmdType string, args []string) error {    fmt.Printf("DEJDEJ id:",3611)
...
func modNeighbor(cmdType string, args []string) error {    fmt.Printf("DEJDEJ id:",3612)
...
func NewNeighborCmd() *cobra.Command {    fmt.Printf("DEJDEJ id:",3613)
