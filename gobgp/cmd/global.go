...
func rateLimitParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3636)
...
func redirectParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3637)
...
func markParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3638)
...
func actionParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3639)
...
func rtParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3640)
...
func encapParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3641)
...
func esiLabelParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3642)
...
func routerMacParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3643)
...
func defaultGatewayParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3644)
...
func validationParser(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3645)
...
func ParseExtendedCommunities(args []string) ([]bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3646)
...
func ParseFlowSpecArgs(rf bgp.RouteFamily, args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3647)
...
func ParseEvpnEthernetAutoDiscoveryArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3648)
...
func ParseEvpnMacAdvArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3649)
...
func ParseEvpnMulticastArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3650)
...
func ParseEvpnEthernetSegmentArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3651)
...
func ParseEvpnIPPrefixArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3652)
...
func ParseEvpnArgs(args []string) (bgp.AddrPrefixInterface, []string, error) {    fmt.Printf("DEJDEJ id:",3653)
...
func extractOrigin(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3654)
...
func toAs4Value(s string) (uint32, error) {    fmt.Printf("DEJDEJ id:",3655)
...
func newAsPath(aspath string) (bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3656)
...
func extractAsPath(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3657)
...
func extractNexthop(rf bgp.RouteFamily, args []string) ([]string, string, error) {    fmt.Printf("DEJDEJ id:",3658)
...
func extractLocalPref(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3659)
...
func extractMed(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3660)
...
func extractCommunity(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3661)
...
func extractLargeCommunity(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3662)
...
func extractPmsiTunnel(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3663)
...
func extractAigp(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3664)
...
func extractAggregator(args []string) ([]string, bgp.PathAttributeInterface, error) {    fmt.Printf("DEJDEJ id:",3665)
...
func extractRouteDistinguisher(args []string) ([]string, bgp.RouteDistinguisherInterface, error) {    fmt.Printf("DEJDEJ id:",3666)
...
func ParsePath(rf bgp.RouteFamily, args []string) (*table.Path, error) {    fmt.Printf("DEJDEJ id:",3667)
...
func showGlobalRib(args []string) error {    fmt.Printf("DEJDEJ id:",3668)

	return showNeighborRib(CMD_GLOBAL, "", args)
}

func modPath(resource string, name, modtype string, args []string) error {    fmt.Printf("DEJDEJ id:",3669)
...
func showGlobalConfig() error {    fmt.Printf("DEJDEJ id:",3670)
...
func modGlobalConfig(args []string) error {    fmt.Printf("DEJDEJ id:",3671)
...
func NewGlobalCmd() *cobra.Command {    fmt.Printf("DEJDEJ id:",3672)
