...
func (h *BMPHeader) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1850)
...
func (h *BMPHeader) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1851)
...
func NewBMPPeerHeader(t uint8, flags uint8, dist uint64, address string, as uint32, id string, stamp float64) *BMPPeerHeader {    fmt.Printf("DEJDEJ id:",1852)
...
func (h *BMPPeerHeader) IsPostPolicy() bool {    fmt.Printf("DEJDEJ id:",1853)
...
func (h *BMPPeerHeader) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1854)
...
func (h *BMPPeerHeader) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1855)
...
func NewBMPRouteMonitoring(p BMPPeerHeader, update *bgp.BGPMessage) *BMPMessage {    fmt.Printf("DEJDEJ id:",1856)
...
func (body *BMPRouteMonitoring) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1857)
...
func (body *BMPRouteMonitoring) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1858)
...
func NewBMPStatsTLV32(t uint16, v uint32) *BMPStatsTLV32 {    fmt.Printf("DEJDEJ id:",1859)
...
func (s *BMPStatsTLV32) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1860)
...
func (s *BMPStatsTLV32) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1861)
...
func NewBMPStatsTLV64(t uint16, v uint64) *BMPStatsTLV64 {    fmt.Printf("DEJDEJ id:",1862)
...
func (s *BMPStatsTLV64) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1863)
...
func (s *BMPStatsTLV64) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1864)
...
func NewBMPStatsTLVPerAfiSafi64(t uint16, afi uint16, safi uint8, v uint64) *BMPStatsTLVPerAfiSafi64 {    fmt.Printf("DEJDEJ id:",1865)
...
func (s *BMPStatsTLVPerAfiSafi64) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1866)
...
func (s *BMPStatsTLVPerAfiSafi64) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1867)
...
func NewBMPStatisticsReport(p BMPPeerHeader, stats []BMPStatsTLVInterface) *BMPMessage {    fmt.Printf("DEJDEJ id:",1868)
...
func (body *BMPStatisticsReport) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1869)
...
func (body *BMPStatisticsReport) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1870)
...
func NewBMPPeerDownNotification(p BMPPeerHeader, reason uint8, notification *bgp.BGPMessage, data []byte) *BMPMessage {    fmt.Printf("DEJDEJ id:",1871)
...
func (body *BMPPeerDownNotification) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1872)
...
func (body *BMPPeerDownNotification) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1873)
...
func NewBMPPeerUpNotification(p BMPPeerHeader, lAddr string, lPort, rPort uint16, sent, recv *bgp.BGPMessage) *BMPMessage {    fmt.Printf("DEJDEJ id:",1874)
...
func (body *BMPPeerUpNotification) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1875)
...
func (body *BMPPeerUpNotification) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1876)
...
func NewBMPInfoTLVString(t uint16, v string) *BMPInfoTLVString {    fmt.Printf("DEJDEJ id:",1877)
...
func (s *BMPInfoTLVString) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1878)

	s.Value = string(data[:s.Length])
	return nil
}

func (s *BMPInfoTLVString) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1879)
...
func NewBMPInfoTLVUnknown(t uint16, v []byte) *BMPInfoTLVUnknown {    fmt.Printf("DEJDEJ id:",1880)
...
func (s *BMPInfoTLVUnknown) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1881)

	s.Value = data[:s.Length]
	return nil
}

func (s *BMPInfoTLVUnknown) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1882)
...
func NewBMPInitiation(info []BMPInfoTLVInterface) *BMPMessage {    fmt.Printf("DEJDEJ id:",1883)
...
func (body *BMPInitiation) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1884)
...
func (body *BMPInitiation) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1885)
...
func NewBMPTermTLVString(t uint16, v string) *BMPTermTLVString {    fmt.Printf("DEJDEJ id:",1886)
...
func (s *BMPTermTLVString) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1887)

	s.Value = string(data[:s.Length])
	return nil
}

func (s *BMPTermTLVString) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1888)
...
func NewBMPTermTLV16(t uint16, v uint16) *BMPTermTLV16 {    fmt.Printf("DEJDEJ id:",1889)
...
func (s *BMPTermTLV16) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1890)

	s.Value = binary.BigEndian.Uint16(data[:2])
	return nil
}

func (s *BMPTermTLV16) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1891)
...
func NewBMPTermTLVUnknown(t uint16, v []byte) *BMPTermTLVUnknown {    fmt.Printf("DEJDEJ id:",1892)
...
func (s *BMPTermTLVUnknown) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1893)

	s.Value = data[:s.Length]
	return nil
}

func (s *BMPTermTLVUnknown) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1894)
...
func NewBMPTermination(info []BMPTermTLVInterface) *BMPMessage {    fmt.Printf("DEJDEJ id:",1895)
...
func (body *BMPTermination) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1896)
...
func (body *BMPTermination) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1897)
...
func NewBMPRouteMirrTLVBGPMsg(t uint16, v *bgp.BGPMessage) *BMPRouteMirrTLVBGPMsg {    fmt.Printf("DEJDEJ id:",1898)
...
func (s *BMPRouteMirrTLVBGPMsg) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1899)
...
func (s *BMPRouteMirrTLVBGPMsg) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1900)
...
func NewBMPRouteMirrTLV16(t uint16, v uint16) *BMPRouteMirrTLV16 {    fmt.Printf("DEJDEJ id:",1901)
...
func (s *BMPRouteMirrTLV16) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1902)

	s.Value = binary.BigEndian.Uint16(data[:2])
	return nil
}

func (s *BMPRouteMirrTLV16) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1903)
...
func NewBMPRouteMirrTLVUnknown(t uint16, v []byte) *BMPRouteMirrTLVUnknown {    fmt.Printf("DEJDEJ id:",1904)
...
func (s *BMPRouteMirrTLVUnknown) ParseValue(data []byte) error {    fmt.Printf("DEJDEJ id:",1905)

	s.Value = data[:s.Length]
	return nil
}

func (s *BMPRouteMirrTLVUnknown) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1906)
...
func NewBMPRouteMirroring(p BMPPeerHeader, info []BMPRouteMirrTLVInterface) *BMPMessage {    fmt.Printf("DEJDEJ id:",1907)
...
func (body *BMPRouteMirroring) ParseBody(msg *BMPMessage, data []byte) error {    fmt.Printf("DEJDEJ id:",1908)
...
func (body *BMPRouteMirroring) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1909)
...
func (msg *BMPMessage) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1910)
...
func (msg *BMPMessage) Len() int {    fmt.Printf("DEJDEJ id:",1911)
...
func ParseBMPMessage(data []byte) (msg *BMPMessage, err error) {    fmt.Printf("DEJDEJ id:",1912)
...
func SplitBMP(data []byte, atEOF bool) (advance int, token []byte, err error) {    fmt.Printf("DEJDEJ id:",1913)
