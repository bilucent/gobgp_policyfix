...
func verify(t *testing.T, m1 *BMPMessage) {    fmt.Printf("DEJDEJ id:",1914)
...
func Test_Initiation(t *testing.T) {    fmt.Printf("DEJDEJ id:",1915)
...
func Test_Termination(t *testing.T) {    fmt.Printf("DEJDEJ id:",1916)
...
func Test_PeerUpNotification(t *testing.T) {    fmt.Printf("DEJDEJ id:",1917)
...
func Test_PeerDownNotification(t *testing.T) {    fmt.Printf("DEJDEJ id:",1918)
...
func Test_RouteMonitoring(t *testing.T) {    fmt.Printf("DEJDEJ id:",1919)
...
func Test_StatisticsReport(t *testing.T) {    fmt.Printf("DEJDEJ id:",1920)
...
func Test_RouteMirroring(t *testing.T) {    fmt.Printf("DEJDEJ id:",1921)
...
func Test_BogusHeader(t *testing.T) {    fmt.Printf("DEJDEJ id:",1922)
