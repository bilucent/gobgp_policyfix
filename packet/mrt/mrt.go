...
func (t MRTSubTypeTableDumpv2) ToUint16() uint16 {    fmt.Printf("DEJDEJ id:",1923)
...
func (t MRTSubTypeBGP4MP) ToUint16() uint16 {    fmt.Printf("DEJDEJ id:",1924)
...
func packValues(values []interface{    fmt.Printf("DEJDEJ id:",1925)
}) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1925)
...
func (h *MRTHeader) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1926)
...
func (h *MRTHeader) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1927)

	return packValues([]interface{}{h.Timestamp, h.Type, h.SubType, h.Len})
}

func NewMRTHeader(timestamp uint32, t MRTType, subtype MRTSubTyper, l uint32) (*MRTHeader, error) {    fmt.Printf("DEJDEJ id:",1928)
...
func (h *MRTHeader) GetTime() time.Time {    fmt.Printf("DEJDEJ id:",1929)
...
func (m *MRTMessage) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1930)
...
func NewMRTMessage(timestamp uint32, t MRTType, subtype MRTSubTyper, body Body) (*MRTMessage, error) {    fmt.Printf("DEJDEJ id:",1931)
...
func (p *Peer) DecodeFromBytes(data []byte) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1932)
...
func (p *Peer) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1933)
...
func NewPeer(bgpid string, ipaddr string, asn uint32, isAS4 bool) *Peer {    fmt.Printf("DEJDEJ id:",1934)
...
func (p *Peer) String() string {    fmt.Printf("DEJDEJ id:",1935)
...
func (t *PeerIndexTable) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1936)
...
func (t *PeerIndexTable) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1937)
...
func NewPeerIndexTable(bgpid string, viewname string, peers []*Peer) *PeerIndexTable {    fmt.Printf("DEJDEJ id:",1938)
...
func (t *PeerIndexTable) String() string {    fmt.Printf("DEJDEJ id:",1939)
...
func (e *RibEntry) DecodeFromBytes(data []byte) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1940)
...
func (e *RibEntry) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1941)
...
func NewRibEntry(index uint16, time uint32, pathId uint32, pathAttrs []bgp.PathAttributeInterface, isAddPath bool) *RibEntry {    fmt.Printf("DEJDEJ id:",1942)
...
func (e *RibEntry) String() string {    fmt.Printf("DEJDEJ id:",1943)
...
func (u *Rib) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1944)
...
func (u *Rib) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1945)
...
func NewRib(seq uint32, prefix bgp.AddrPrefixInterface, entries []*RibEntry) *Rib {    fmt.Printf("DEJDEJ id:",1946)
...
func (u *Rib) String() string {    fmt.Printf("DEJDEJ id:",1947)
...
func (p *GeoPeer) DecodeFromBytes(data []byte) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1948)
...
func (p *GeoPeer) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1949)
...
func NewGeoPeer(bgpid string, latitude float32, longitude float32) *GeoPeer {    fmt.Printf("DEJDEJ id:",1950)
...
func (p *GeoPeer) String() string {    fmt.Printf("DEJDEJ id:",1951)
...
func (t *GeoPeerTable) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1952)
...
func (t *GeoPeerTable) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1953)
...
func NewGeoPeerTable(bgpid string, latitude float32, longitude float32, peers []*GeoPeer) *GeoPeerTable {    fmt.Printf("DEJDEJ id:",1954)
...
func (t *GeoPeerTable) String() string {    fmt.Printf("DEJDEJ id:",1955)
...
func (m *BGP4MPHeader) decodeFromBytes(data []byte) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1956)
...
func (m *BGP4MPHeader) serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1957)
...
func newBGP4MPHeader(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool) (*BGP4MPHeader, error) {    fmt.Printf("DEJDEJ id:",1958)
...
func (m *BGP4MPStateChange) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1959)
...
func (m *BGP4MPStateChange) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1960)
...
func NewBGP4MPStateChange(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool, oldstate, newstate BGPState) *BGP4MPStateChange {    fmt.Printf("DEJDEJ id:",1961)
...
func (m *BGP4MPMessage) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",1962)
...
func (m *BGP4MPMessage) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",1963)
...
func NewBGP4MPMessage(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool, msg *bgp.BGPMessage) *BGP4MPMessage {    fmt.Printf("DEJDEJ id:",1964)
...
func NewBGP4MPMessageLocal(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool, msg *bgp.BGPMessage) *BGP4MPMessage {    fmt.Printf("DEJDEJ id:",1965)
...
func NewBGP4MPMessageAddPath(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool, msg *bgp.BGPMessage) *BGP4MPMessage {    fmt.Printf("DEJDEJ id:",1966)
...
func NewBGP4MPMessageLocalAddPath(peeras, localas uint32, intfindex uint16, peerip, localip string, isAS4 bool, msg *bgp.BGPMessage) *BGP4MPMessage {    fmt.Printf("DEJDEJ id:",1967)
...
func (m *BGP4MPMessage) String() string {    fmt.Printf("DEJDEJ id:",1968)
...
func SplitMrt(data []byte, atEOF bool) (advance int, token []byte, err error) {    fmt.Printf("DEJDEJ id:",1969)
...
func ParseMRTBody(h *MRTHeader, data []byte) (*MRTMessage, error) {    fmt.Printf("DEJDEJ id:",1970)
