...
func verifyRTRMessage(t *testing.T, m1 RTRMessage) {    fmt.Printf("DEJDEJ id:",1820)
...
func randUint32() uint32 {    fmt.Printf("DEJDEJ id:",1821)

	rand.Seed(time.Now().UnixNano())
	return rand.Uint32()
}

func Test_RTRSerialNotify(t *testing.T) {    fmt.Printf("DEJDEJ id:",1822)
...
func Test_RTRSerialQuery(t *testing.T) {    fmt.Printf("DEJDEJ id:",1823)
...
func Test_RTRResetQuery(t *testing.T) {    fmt.Printf("DEJDEJ id:",1824)

	verifyRTRMessage(t, NewRTRResetQuery())
}

func Test_RTRCacheResponse(t *testing.T) {    fmt.Printf("DEJDEJ id:",1825)
...
func Test_RTRIPPrefix(t *testing.T) {    fmt.Printf("DEJDEJ id:",1826)
...
func Test_RTREndOfData(t *testing.T) {    fmt.Printf("DEJDEJ id:",1827)
...
func Test_RTRCacheReset(t *testing.T) {    fmt.Printf("DEJDEJ id:",1828)

	verifyRTRMessage(t, NewRTRCacheReset())
}

func Test_RTRErrorReport(t *testing.T) {    fmt.Printf("DEJDEJ id:",1829)
