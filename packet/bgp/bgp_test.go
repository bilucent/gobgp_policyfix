...
func keepalive() *BGPMessage { 
   fmt.Print("<<<DEJDEJ id:2502, bgp_test.go:keepalive()>>>")
	return NewBGPKeepAliveMessage()
}

func notification() *BGPMessage { 
   fmt.Print("<<<DEJDEJ id:2503, bgp_test.go:notification()>>>")
	return NewBGPNotificationMessage(1, 2, nil)
}

func refresh() *BGPMessage { 
   fmt.Print("<<<DEJDEJ id:2504, bgp_test.go:refresh()>>>")
	return NewBGPRouteRefreshMessage(1, 2, 10)
}

func Test_Message(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2505, bgp_test.go:Test_Message(t>>>")
...
func Test_IPAddrPrefixString(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2506, bgp_test.go:Test_IPAddrPrefixString(t>>>")
...
func Test_RouteTargetMembershipNLRIString(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2507, bgp_test.go:Test_RouteTargetMembershipNLRIString(t>>>")
	assert := assert.New(t)
...
func Test_MalformedUpdateMsg(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2508, bgp_test.go:Test_MalformedUpdateMsg(t>>>")
	assert := assert.New(t)
...
func Test_RFC5512(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2509, bgp_test.go:Test_RFC5512(t>>>")
	assert := assert.New(t)
...
func Test_ASLen(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2510, bgp_test.go:Test_ASLen(t>>>")
	assert := assert.New(t)
...
func Test_MPLSLabelStack(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2511, bgp_test.go:Test_MPLSLabelStack(t>>>")
	assert := assert.New(t)
...
func Test_FlowSpecNlri(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2512, bgp_test.go:Test_FlowSpecNlri(t>>>")
	assert := assert.New(t)
...
func Test_FlowSpecExtended(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2513, bgp_test.go:Test_FlowSpecExtended(t>>>")
	assert := assert.New(t)
...
func Test_IP6FlowSpecExtended(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2514, bgp_test.go:Test_IP6FlowSpecExtended(t>>>")
	assert := assert.New(t)
	exts := make([]ExtendedCommunityInterface, 0)
...
func Test_FlowSpecNlriv6(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2515, bgp_test.go:Test_FlowSpecNlriv6(t>>>")
	assert := assert.New(t)
	cmp := make([]FlowSpecComponentInterface, 0)
...
func Test_Aigp(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2516, bgp_test.go:Test_Aigp(t>>>")
	assert := assert.New(t)
...
func Test_FlowSpecNlriL2(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2517, bgp_test.go:Test_FlowSpecNlriL2(t>>>")
	assert := assert.New(t)
...
func Test_NotificationErrorCode(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2518, bgp_test.go:Test_NotificationErrorCode(t>>>")
	// boundary check
...
func Test_FlowSpecNlriVPN(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2519, bgp_test.go:Test_FlowSpecNlriVPN(t>>>")
	assert := assert.New(t)
	cmp := make([]FlowSpecComponentInterface, 0)
	cmp = append(cmp, NewFlowSpecDestinationPrefix(NewIPAddrPrefix(24, "10.0.0.0")))
	cmp = append(cmp, NewFlowSpecSourcePrefix(NewIPAddrPrefix(24, "10.0.0.0")))
...
func Test_EVPNIPPrefixRoute(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2520, bgp_test.go:Test_EVPNIPPrefixRoute(t>>>")
	assert := assert.New(t)
	rd, _ := ParseRouteDistinguisher("100:100")
	r := &EVPNIPPrefixRoute{
		RD: rd,
...
func Test_CapExtendedNexthop(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2521, bgp_test.go:Test_CapExtendedNexthop(t>>>")
	assert := assert.New(t)
...
func Test_AddPath(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2522, bgp_test.go:Test_AddPath(t>>>")
	assert := assert.New(t)
...
func Test_CompareFlowSpecNLRI(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2523, bgp_test.go:Test_CompareFlowSpecNLRI(t>>>")
	assert := assert.New(t)
...
func Test_MpReachNLRIWithIPv4MappedIPv6Prefix(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2524, bgp_test.go:Test_MpReachNLRIWithIPv4MappedIPv6Prefix(t>>>")
	assert := assert.New(t)
...
func Test_MpReachNLRIWithIPv6PrefixWithIPv4Peering(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2525, bgp_test.go:Test_MpReachNLRIWithIPv6PrefixWithIPv4Peering(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpReachNLRIWithIPv6(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2526, bgp_test.go:Test_MpReachNLRIWithIPv6(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpUnreachNLRIWithIPv6(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2527, bgp_test.go:Test_MpUnreachNLRIWithIPv6(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpReachNLRIWithIPv6PrefixWithLinkLocalNexthop(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2528, bgp_test.go:Test_MpReachNLRIWithIPv6PrefixWithLinkLocalNexthop(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpReachNLRIWithVPNv4Prefix(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2529, bgp_test.go:Test_MpReachNLRIWithVPNv4Prefix(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpReachNLRIWithVPNv6Prefix(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2530, bgp_test.go:Test_MpReachNLRIWithVPNv6Prefix(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_MpReachNLRIWithIPv4PrefixWithIPv6Nexthop(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2531, bgp_test.go:Test_MpReachNLRIWithIPv4PrefixWithIPv6Nexthop(t>>>")
	assert := assert.New(t)
	bufin := []byte{
...
func Test_ParseRouteDistinguisher(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2532, bgp_test.go:Test_ParseRouteDistinguisher(t>>>")
	assert := assert.New(t)
...
func Test_ParseEthernetSegmentIdentifier(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:2533, bgp_test.go:Test_ParseEthernetSegmentIdentifier(t>>>")
	assert := assert.New(t)
