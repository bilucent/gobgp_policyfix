...
func (p Protocol) String() string {    fmt.Printf("DEJDEJ id:",2667)
...
func (f TCPFlag) String() string {    fmt.Printf("DEJDEJ id:",2668)
...
func (f BitmaskFlagOp) String() string {    fmt.Printf("DEJDEJ id:",2669)
...
func (f FragmentFlag) String() string {    fmt.Printf("DEJDEJ id:",2670)
...
func (f DECNumOp) String() string {    fmt.Printf("DEJDEJ id:",2671)
...
func (t EthernetType) String() string {    fmt.Printf("DEJDEJ id:",2672)
