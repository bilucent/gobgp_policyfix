...
func TestAsPathAs2Trans1(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1267::message_test.go:TestAsPathAs2Trans1(t>>>")
...
func TestAsPathAs2Trans2(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1268::message_test.go:TestAsPathAs2Trans2(t>>>")
...
func TestAsPathAs4Trans1(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1269::message_test.go:TestAsPathAs4Trans1(t>>>")
...
func TestAsPathAs4Trans2(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1270::message_test.go:TestAsPathAs4Trans2(t>>>")
...
func TestAsPathAs4Trans3(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1271::message_test.go:TestAsPathAs4Trans3(t>>>")
	as1 := []uint16{65000, 4000}
	param1 := bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as1)
	as2 := []uint16{10, 20, 30}
	param2 := bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SET, as2)
...
func TestAsPathAs4Trans4(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1272::message_test.go:TestAsPathAs4Trans4(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestAsPathAs4Trans5(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1273::message_test.go:TestAsPathAs4Trans5(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestAsPathAs4TransInvalid1(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1274::message_test.go:TestAsPathAs4TransInvalid1(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestAsPathAs4TransInvalid2(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1275::message_test.go:TestAsPathAs4TransInvalid2(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestAsPathAs4TransInvalid3(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1276::message_test.go:TestAsPathAs4TransInvalid3(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestAsPathAs4TransInvalid4(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1277::message_test.go:TestAsPathAs4TransInvalid4(t>>>")
	as := []uint16{65000, 4000, bgp.AS_TRANS, bgp.AS_TRANS, 40001}
	params := []bgp.AsPathParamInterface{bgp.NewAsPathParam(bgp.BGP_ASPATH_ATTR_TYPE_SEQ, as)}
	aspath := bgp.NewPathAttributeAsPath(params)
...
func TestASPathAs4TransMultipleParams(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1278::message_test.go:TestASPathAs4TransMultipleParams(t>>>")
...
func TestASPathAs4TransMultipleLargeParams(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1279::message_test.go:TestASPathAs4TransMultipleLargeParams(t>>>")
...
func TestAggregator4BytesASes(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1280::message_test.go:TestAggregator4BytesASes(t>>>")
...
func TestBMP(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1281::message_test.go:TestBMP(t>>>")
...
func unreachIndex(msgs []*bgp.BGPMessage) int { 
   fmt.Print("<<<DEJDEJ id:1282::message_test.go:unreachIndex(msgs>>>")
	for i, _ := range msgs {
...
func TestMixedMPReachMPUnreach(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1283::message_test.go:TestMixedMPReachMPUnreach(t>>>")
	aspath1 := []bgp.AsPathParamInterface{
...
func TestMixedNLRIAndMPUnreach(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1284::message_test.go:TestMixedNLRIAndMPUnreach(t>>>")
	aspath1 := []bgp.AsPathParamInterface{
		bgp.NewAs4PathParam(2, []uint32{100}),
	}
...
func TestMergeV4NLRIs(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1285::message_test.go:TestMergeV4NLRIs(t>>>")
	aspath1 := []bgp.AsPathParamInterface{
		bgp.NewAs4PathParam(2, []uint32{100}),
	}
...
func TestNotMergeV4NLRIs(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1286::message_test.go:TestNotMergeV4NLRIs(t>>>")
	paths := make([]*Path, 0, 2)
...
func TestMergeV4Withdraw(t *testing.T) { 
   fmt.Print("<<<DEJDEJ id:1287::message_test.go:TestMergeV4Withdraw(t>>>")
	nr := 1024
	paths := make([]*Path, 0, nr)
	addrs := make([]string, 0, nr)
	for i := 0; i < nr; i++ {
