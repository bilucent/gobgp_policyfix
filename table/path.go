...
func (p *Path) SetHash(v uint32) {
   fmt.Printf("DEJDEJ id:",2916)
	p.attrsHash = v
}

func (p *Path) GetHash() uint32 {
   fmt.Printf("DEJDEJ id:",2917)
	return p.attrsHash
}
