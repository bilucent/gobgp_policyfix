...
func NewAdjRib(id string, rfList []bgp.RouteFamily) *AdjRib {    fmt.Printf("DEJDEJ id:",2679)
...
func (adj *AdjRib) Update(pathList []*Path) {    fmt.Printf("DEJDEJ id:",2680)
...
func (adj *AdjRib) RefreshAcceptedNumber(rfList []bgp.RouteFamily) {    fmt.Printf("DEJDEJ id:",2681)
...
func (adj *AdjRib) PathList(rfList []bgp.RouteFamily, accepted bool) []*Path {    fmt.Printf("DEJDEJ id:",2682)
...
func (adj *AdjRib) Count(rfList []bgp.RouteFamily) int {    fmt.Printf("DEJDEJ id:",2683)
...
func (adj *AdjRib) Accepted(rfList []bgp.RouteFamily) int {    fmt.Printf("DEJDEJ id:",2684)
...
func (adj *AdjRib) Drop(rfList []bgp.RouteFamily) {    fmt.Printf("DEJDEJ id:",2685)
...
func (adj *AdjRib) DropStale(rfList []bgp.RouteFamily) []*Path {    fmt.Printf("DEJDEJ id:",2686)
...
func (adj *AdjRib) StaleAll(rfList []bgp.RouteFamily) {    fmt.Printf("DEJDEJ id:",2687)
...
func (adj *AdjRib) Exists(path *Path) bool {    fmt.Printf("DEJDEJ id:",2688)
...
func (adj *AdjRib) Select(family bgp.RouteFamily, accepted bool, option ...TableSelectOption) (*Table, error) {    fmt.Printf("DEJDEJ id:",2689)
...
func (adj *AdjRib) TableInfo(family bgp.RouteFamily) (*TableInfo, error) {    fmt.Printf("DEJDEJ id:",2690)
