...
func TestPathNewIPv4(t *testing.T) {    fmt.Printf("DEJDEJ id:",2756)
...
func TestPathNewIPv6(t *testing.T) {    fmt.Printf("DEJDEJ id:",2757)
...
func TestPathGetNlri(t *testing.T) {    fmt.Printf("DEJDEJ id:",2758)
...
func TestPathCreatePath(t *testing.T) {    fmt.Printf("DEJDEJ id:",2759)
...
func TestPathGetPrefix(t *testing.T) {    fmt.Printf("DEJDEJ id:",2760)
...
func TestPathGetAttribute(t *testing.T) {    fmt.Printf("DEJDEJ id:",2761)
...
func TestASPathLen(t *testing.T) {    fmt.Printf("DEJDEJ id:",2762)
...
func TestPathPrependAsnToExistingSeqAttr(t *testing.T) {    fmt.Printf("DEJDEJ id:",2763)
...
func TestPathPrependAsnToNewAsPathAttr(t *testing.T) {    fmt.Printf("DEJDEJ id:",2764)
...
func TestPathPrependAsnToNewAsPathSeq(t *testing.T) {    fmt.Printf("DEJDEJ id:",2765)
...
func TestPathPrependAsnToEmptyAsPathAttr(t *testing.T) {    fmt.Printf("DEJDEJ id:",2766)
...
func TestPathPrependAsnToFullPathAttr(t *testing.T) {    fmt.Printf("DEJDEJ id:",2767)
...
func TestGetPathAttrs(t *testing.T) {    fmt.Printf("DEJDEJ id:",2768)
...
func PathCreatePeer() []*PeerInfo {    fmt.Printf("DEJDEJ id:",2769)
...
func PathCreatePath(peerP []*PeerInfo) []*Path {    fmt.Printf("DEJDEJ id:",2770)
...
func updateMsgP1() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2771)
...
func updateMsgP2() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2772)
...
func updateMsgP3() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2773)
...
func TestRemovePrivateAS(t *testing.T) {    fmt.Printf("DEJDEJ id:",2774)
...
func TestReplaceAS(t *testing.T) {    fmt.Printf("DEJDEJ id:",2775)
