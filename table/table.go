...
func NewTable(rf bgp.RouteFamily, dsts ...*Destination) *Table {    fmt.Printf("DEJDEJ id:",2918)
...
func (t *Table) GetRoutefamily() bgp.RouteFamily {    fmt.Printf("DEJDEJ id:",2919)

	return t.routeFamily
}

func (t *Table) insert(path *Path) *Destination {    fmt.Printf("DEJDEJ id:",2920)
...
func (t *Table) DeleteDestByPeer(peerInfo *PeerInfo) []*Destination {    fmt.Printf("DEJDEJ id:",2921)
...
func (t *Table) deletePathsByVrf(vrf *Vrf) []*Path {    fmt.Printf("DEJDEJ id:",2922)
...
func (t *Table) deleteRTCPathsByVrf(vrf *Vrf, vrfs map[string]*Vrf) []*Path {    fmt.Printf("DEJDEJ id:",2923)
...
func (t *Table) deleteDestByNlri(nlri bgp.AddrPrefixInterface) *Destination {    fmt.Printf("DEJDEJ id:",2924)
...
func (t *Table) deleteDest(dest *Destination) {    fmt.Printf("DEJDEJ id:",2925)
...
func (t *Table) validatePath(path *Path) {    fmt.Printf("DEJDEJ id:",2926)
...
func (t *Table) getOrCreateDest(nlri bgp.AddrPrefixInterface) *Destination {    fmt.Printf("DEJDEJ id:",2927)
...
func (t *Table) GetSortedDestinations() []*Destination {    fmt.Printf("DEJDEJ id:",2928)
...
func (t *Table) GetDestinations() map[string]*Destination {    fmt.Printf("DEJDEJ id:",2929)

	return t.destinations
}
func (t *Table) setDestinations(destinations map[string]*Destination) {    fmt.Printf("DEJDEJ id:",2930)

	t.destinations = destinations
}
func (t *Table) GetDestination(key string) *Destination {    fmt.Printf("DEJDEJ id:",2931)
...
func (t *Table) GetLongerPrefixDestinations(key string) ([]*Destination, error) {    fmt.Printf("DEJDEJ id:",2932)
...
func (t *Table) GetEvpnDestinationsWithRouteType(typ string) ([]*Destination, error) {    fmt.Printf("DEJDEJ id:",2933)
...
func (t *Table) setDestination(key string, dest *Destination) {    fmt.Printf("DEJDEJ id:",2934)

	t.destinations[key] = dest
}

func (t *Table) tableKey(nlri bgp.AddrPrefixInterface) string {    fmt.Printf("DEJDEJ id:",2935)

	return nlri.String()
}

func (t *Table) Bests(id string) []*Path {    fmt.Printf("DEJDEJ id:",2936)
...
func (t *Table) MultiBests(id string) [][]*Path {    fmt.Printf("DEJDEJ id:",2937)
...
func (t *Table) GetKnownPathList(id string) []*Path {    fmt.Printf("DEJDEJ id:",2938)
...
func (t *Table) Select(option ...TableSelectOption) (*Table, error) {    fmt.Printf("DEJDEJ id:",2939)
...
func (t *Table) Info(id string) *TableInfo {    fmt.Printf("DEJDEJ id:",2940)
