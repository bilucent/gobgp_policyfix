...
func UpdatePathAttrs2ByteAs(msg *bgp.BGPUpdate) error {    fmt.Printf("DEJDEJ id:",2732)
...
func UpdatePathAttrs4ByteAs(msg *bgp.BGPUpdate) error {    fmt.Printf("DEJDEJ id:",2733)
...
func UpdatePathAggregator2ByteAs(msg *bgp.BGPUpdate) {    fmt.Printf("DEJDEJ id:",2734)
...
func UpdatePathAggregator4ByteAs(msg *bgp.BGPUpdate) error {    fmt.Printf("DEJDEJ id:",2735)
...
func newCage(b []byte, path *Path) *cage {    fmt.Printf("DEJDEJ id:",2736)
...
func (p *packerMP) add(path *Path) {    fmt.Printf("DEJDEJ id:",2737)
...
func createMPReachMessage(path *Path) *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2738)
...
func (p *packerMP) pack(options ...*bgp.MarshallingOption) []*bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2739)
...
func newPackerMP(f bgp.RouteFamily) *packerMP {    fmt.Printf("DEJDEJ id:",2740)
...
func (p *packerV4) add(path *Path) {    fmt.Printf("DEJDEJ id:",2741)
...
func (p *packerV4) pack(options ...*bgp.MarshallingOption) []*bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2742)
...
func newPackerV4(f bgp.RouteFamily) *packerV4 {    fmt.Printf("DEJDEJ id:",2743)
...
func newPacker(f bgp.RouteFamily) packerInterface {    fmt.Printf("DEJDEJ id:",2744)
...
func CreateUpdateMsgFromPaths(pathList []*Path, options ...*bgp.MarshallingOption) []*bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2745)
