...
func TestTableDeleteDestByNlri(t *testing.T) {    fmt.Printf("DEJDEJ id:",2746)
...
func TestTableDeleteDest(t *testing.T) {    fmt.Printf("DEJDEJ id:",2747)
...
func TestTableGetRouteFamily(t *testing.T) {    fmt.Printf("DEJDEJ id:",2748)
...
func TestTableSetDestinations(t *testing.T) {    fmt.Printf("DEJDEJ id:",2749)
...
func TestTableGetDestinations(t *testing.T) {    fmt.Printf("DEJDEJ id:",2750)
...
func TableCreatePeer() []*PeerInfo {    fmt.Printf("DEJDEJ id:",2751)
...
func TableCreatePath(peerT []*PeerInfo) []*Path {    fmt.Printf("DEJDEJ id:",2752)
...
func updateMsgT1() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2753)
...
func updateMsgT2() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2754)
...
func updateMsgT3() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",2755)
