...
func (r *BestPathReason) String() string {    fmt.Printf("DEJDEJ id:",2941)

	return BestPathReasonStringMap[*r]
}

func IpToRadixkey(b []byte, max uint8) string {    fmt.Printf("DEJDEJ id:",2942)
...
func CidrToRadixkey(cidr string) string {    fmt.Printf("DEJDEJ id:",2943)
...
func AddrToRadixkey(addr bgp.AddrPrefixInterface) string {    fmt.Printf("DEJDEJ id:",2944)
...
func (lhs *PeerInfo) Equal(rhs *PeerInfo) bool {    fmt.Printf("DEJDEJ id:",2945)
...
func (i *PeerInfo) String() string {    fmt.Printf("DEJDEJ id:",2946)
...
func NewPeerInfo(g *config.Global, p *config.Neighbor) *PeerInfo {    fmt.Printf("DEJDEJ id:",2947)
...
func NewDestination(nlri bgp.AddrPrefixInterface, mapSize int, known ...*Path) *Destination {    fmt.Printf("DEJDEJ id:",2948)
...
func (dd *Destination) Family() bgp.RouteFamily {    fmt.Printf("DEJDEJ id:",2949)

	return dd.routeFamily
}

func (dd *Destination) setRouteFamily(routeFamily bgp.RouteFamily) {    fmt.Printf("DEJDEJ id:",2950)

	dd.routeFamily = routeFamily
}

func (dd *Destination) GetNlri() bgp.AddrPrefixInterface {    fmt.Printf("DEJDEJ id:",2951)

	return dd.nlri
}

func (dd *Destination) setNlri(nlri bgp.AddrPrefixInterface) {    fmt.Printf("DEJDEJ id:",2952)

	dd.nlri = nlri
}

func (dd *Destination) GetAllKnownPathList() []*Path {    fmt.Printf("DEJDEJ id:",2953)

	return dd.knownPathList
}

func (dd *Destination) GetKnownPathList(id string) []*Path {    fmt.Printf("DEJDEJ id:",2954)
...
func getBestPath(id string, pathList *paths) *Path {    fmt.Printf("DEJDEJ id:",2955)
...
func (dd *Destination) GetBestPath(id string) *Path {    fmt.Printf("DEJDEJ id:",2956)

	return getBestPath(id, &dd.knownPathList)
}

func getMultiBestPath(id string, pathList *paths) []*Path {    fmt.Printf("DEJDEJ id:",2957)
...
func (dd *Destination) GetMultiBestPath(id string) []*Path {    fmt.Printf("DEJDEJ id:",2958)

	return getMultiBestPath(id, &dd.knownPathList)
}

func (dd *Destination) GetAddPathChanges(id string) []*Path {    fmt.Printf("DEJDEJ id:",2959)
...
func (dd *Destination) GetChanges(id string, peerDown bool) (*Path, *Path, []*Path) {    fmt.Printf("DEJDEJ id:",2960)
...
func (dd *Destination) AddWithdraw(withdraw *Path) {    fmt.Printf("DEJDEJ id:",2961)

	dd.validatePath(withdraw)
	dd.withdrawList = append(dd.withdrawList, withdraw)
}

func (dd *Destination) AddNewPath(newPath *Path) {    fmt.Printf("DEJDEJ id:",2962)

	dd.validatePath(newPath)
	dd.newPathList = append(dd.newPathList, newPath)
}

func (dd *Destination) validatePath(path *Path) {    fmt.Printf("DEJDEJ id:",2963)
...
func (dest *Destination) Calculate() *Destination {    fmt.Printf("DEJDEJ id:",2964)
...
//
func (dest *Destination) explicitWithdraw() paths {    fmt.Printf("DEJDEJ id:",2965)
...
// new paths.
func (dest *Destination) implicitWithdraw() paths {    fmt.Printf("DEJDEJ id:",2966)
...
func (dest *Destination) computeKnownBestPath() (*Path, BestPathReason, error) {    fmt.Printf("DEJDEJ id:",2967)
...
func (p paths) Len() int {    fmt.Printf("DEJDEJ id:",2968)

	return len(p)
}

func (p paths) Swap(i, j int) {    fmt.Printf("DEJDEJ id:",2969)

	p[i], p[j] = p[j], p[i]
}

func (p paths) Less(i, j int) bool {    fmt.Printf("DEJDEJ id:",2970)
...
func compareByLLGRStaleCommunity(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2971)
...
func compareByReachableNexthop(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2972)
...
func compareByHighestWeight(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2973)
...
func compareByLocalPref(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2974)
...
func compareByLocalOrigin(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2975)
...
func compareByASPath(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2976)
...
func compareByOrigin(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2977)
...
func compareByMED(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2978)
...
func compareByASNumber(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2979)
...
func compareByIGPCost(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2980)
...
func compareByRouterID(path1, path2 *Path) (*Path, error) {    fmt.Printf("DEJDEJ id:",2981)
...
func compareByAge(path1, path2 *Path) *Path {    fmt.Printf("DEJDEJ id:",2982)
...
func (dest *Destination) String() string {    fmt.Printf("DEJDEJ id:",2983)
...
func (d *Destination) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",2984)

	return json.Marshal(d.GetAllKnownPathList())
}

func (old *Destination) Select(option ...DestinationSelectOption) *Destination {    fmt.Printf("DEJDEJ id:",2985)
...
func (d destinations) Len() int {    fmt.Printf("DEJDEJ id:",2986)

	return len(d)
}

func (d destinations) Swap(i, j int) {    fmt.Printf("DEJDEJ id:",2987)

	d[i], d[j] = d[j], d[i]
}

func (d destinations) Less(i, j int) bool {    fmt.Printf("DEJDEJ id:",2988)
