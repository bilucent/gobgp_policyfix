...
func (v *Vrf) Clone() *Vrf {    fmt.Printf("DEJDEJ id:",3279)
...
func isLastTargetUser(vrfs map[string]*Vrf, target bgp.ExtendedCommunityInterface) bool {    fmt.Printf("DEJDEJ id:",3280)
