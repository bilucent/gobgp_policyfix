...
func (t RouteType) String() string {    fmt.Printf("DEJDEJ id:",3051)
...
func (d PolicyDirection) String() string {    fmt.Printf("DEJDEJ id:",3052)
...
func (o MatchOption) String() string {    fmt.Printf("DEJDEJ id:",3053)
...
func (o MatchOption) ConvertToMatchSetOptionsRestrictedType() config.MatchSetOptionsRestrictedType {    fmt.Printf("DEJDEJ id:",3054)
...
func NewMatchOption(c interface{    fmt.Printf("DEJDEJ id:",3055)
}) (MatchOption, error) {    fmt.Printf("DEJDEJ id:",3055)
...
func (c AttributeComparison) String() string {    fmt.Printf("DEJDEJ id:",3056)
...
func (l DefinedSetList) Len() int {    fmt.Printf("DEJDEJ id:",3057)

	return len(l)
}

func (l DefinedSetList) Swap(i, j int) {    fmt.Printf("DEJDEJ id:",3058)

	l[i], l[j] = l[j], l[i]
}

func (l DefinedSetList) Less(i, j int) bool {    fmt.Printf("DEJDEJ id:",3059)
...
func (p *Prefix) Match(path *Path) bool {    fmt.Printf("DEJDEJ id:",3060)
...
func (lhs *Prefix) Equal(rhs *Prefix) bool {    fmt.Printf("DEJDEJ id:",3061)
...
func (p *Prefix) PrefixString() string {    fmt.Printf("DEJDEJ id:",3062)
...
func NewPrefix(c config.Prefix) (*Prefix, error) {    fmt.Printf("DEJDEJ id:",3063)
...
func (s *PrefixSet) Name() string {    fmt.Printf("DEJDEJ id:",3064)

	return s.name
}

func (s *PrefixSet) Type() DefinedType {    fmt.Printf("DEJDEJ id:",3065)

	return DEFINED_TYPE_PREFIX
}

func (lhs *PrefixSet) Append(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3066)
...
func (lhs *PrefixSet) Remove(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3067)
...
func (lhs *PrefixSet) Replace(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3068)
...
func (s *PrefixSet) List() []string {    fmt.Printf("DEJDEJ id:",3069)
...
func (s *PrefixSet) ToConfig() *config.PrefixSet {    fmt.Printf("DEJDEJ id:",3070)
...
func (s *PrefixSet) String() string {    fmt.Printf("DEJDEJ id:",3071)

	return strings.Join(s.List(), "\n")
}

func (s *PrefixSet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3072)

	return json.Marshal(s.ToConfig())
}

func NewPrefixSetFromApiStruct(name string, prefixes []*Prefix) (*PrefixSet, error) {    fmt.Printf("DEJDEJ id:",3073)
...
func NewPrefixSet(c config.PrefixSet) (*PrefixSet, error) {    fmt.Printf("DEJDEJ id:",3074)
...
func (s *NeighborSet) Name() string {    fmt.Printf("DEJDEJ id:",3075)

	return s.name
}

func (s *NeighborSet) Type() DefinedType {    fmt.Printf("DEJDEJ id:",3076)

	return DEFINED_TYPE_NEIGHBOR
}

func (lhs *NeighborSet) Append(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3077)
...
func (lhs *NeighborSet) Remove(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3078)
...
func (lhs *NeighborSet) Replace(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3079)
...
func (s *NeighborSet) List() []string {    fmt.Printf("DEJDEJ id:",3080)
...
func (s *NeighborSet) ToConfig() *config.NeighborSet {    fmt.Printf("DEJDEJ id:",3081)
...
func (s *NeighborSet) String() string {    fmt.Printf("DEJDEJ id:",3082)

	return strings.Join(s.List(), "\n")
}

func (s *NeighborSet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3083)

	return json.Marshal(s.ToConfig())
}

func NewNeighborSetFromApiStruct(name string, list []net.IPNet) (*NeighborSet, error) {    fmt.Printf("DEJDEJ id:",3084)
...
func NewNeighborSet(c config.NeighborSet) (*NeighborSet, error) {    fmt.Printf("DEJDEJ id:",3085)
...
func (lhs *singleAsPathMatch) Equal(rhs *singleAsPathMatch) bool {    fmt.Printf("DEJDEJ id:",3086)

	return lhs.asn == rhs.asn && lhs.mode == rhs.mode
}

func (lhs *singleAsPathMatch) String() string {    fmt.Printf("DEJDEJ id:",3087)
...
func (m *singleAsPathMatch) Match(aspath []uint32) bool {    fmt.Printf("DEJDEJ id:",3088)
...
func NewSingleAsPathMatch(arg string) *singleAsPathMatch {    fmt.Printf("DEJDEJ id:",3089)
...
func (s *AsPathSet) Name() string {    fmt.Printf("DEJDEJ id:",3090)

	return s.name
}

func (s *AsPathSet) Type() DefinedType {    fmt.Printf("DEJDEJ id:",3091)

	return s.typ
}

func (lhs *AsPathSet) Append(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3092)
...
func (lhs *AsPathSet) Remove(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3093)
...
func (lhs *AsPathSet) Replace(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3094)
...
func (s *AsPathSet) List() []string {    fmt.Printf("DEJDEJ id:",3095)
...
func (s *AsPathSet) ToConfig() *config.AsPathSet {    fmt.Printf("DEJDEJ id:",3096)
...
func (s *AsPathSet) String() string {    fmt.Printf("DEJDEJ id:",3097)

	return strings.Join(s.List(), "\n")
}

func (s *AsPathSet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3098)

	return json.Marshal(s.ToConfig())
}

func NewAsPathSet(c config.AsPathSet) (*AsPathSet, error) {    fmt.Printf("DEJDEJ id:",3099)
...
func (s *regExpSet) Name() string {    fmt.Printf("DEJDEJ id:",3100)

	return s.name
}

func (s *regExpSet) Type() DefinedType {    fmt.Printf("DEJDEJ id:",3101)

	return s.typ
}

func (lhs *regExpSet) Append(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3102)
...
func (lhs *regExpSet) Remove(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3103)
...
func (lhs *regExpSet) Replace(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3104)
...
func (s *CommunitySet) List() []string {    fmt.Printf("DEJDEJ id:",3105)
...
func (s *CommunitySet) ToConfig() *config.CommunitySet {    fmt.Printf("DEJDEJ id:",3106)
...
func (s *CommunitySet) String() string {    fmt.Printf("DEJDEJ id:",3107)

	return strings.Join(s.List(), "\n")
}

func (s *CommunitySet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3108)

	return json.Marshal(s.ToConfig())
}

func ParseCommunity(arg string) (uint32, error) {    fmt.Printf("DEJDEJ id:",3109)
...
func ParseExtCommunity(arg string) (bgp.ExtendedCommunityInterface, error) {    fmt.Printf("DEJDEJ id:",3110)
...
func ParseCommunityRegexp(arg string) (*regexp.Regexp, error) {    fmt.Printf("DEJDEJ id:",3111)
...
func ParseExtCommunityRegexp(arg string) (bgp.ExtendedCommunityAttrSubType, *regexp.Regexp, error) {    fmt.Printf("DEJDEJ id:",3112)
...
func NewCommunitySet(c config.CommunitySet) (*CommunitySet, error) {    fmt.Printf("DEJDEJ id:",3113)
...
func (s *ExtCommunitySet) List() []string {    fmt.Printf("DEJDEJ id:",3114)
...
func (s *ExtCommunitySet) ToConfig() *config.ExtCommunitySet {    fmt.Printf("DEJDEJ id:",3115)
...
func (s *ExtCommunitySet) String() string {    fmt.Printf("DEJDEJ id:",3116)

	return strings.Join(s.List(), "\n")
}

func (s *ExtCommunitySet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3117)

	return json.Marshal(s.ToConfig())
}

func NewExtCommunitySet(c config.ExtCommunitySet) (*ExtCommunitySet, error) {    fmt.Printf("DEJDEJ id:",3118)
...
func (s *ExtCommunitySet) Append(arg DefinedSet) error {    fmt.Printf("DEJDEJ id:",3119)
...
func (s *LargeCommunitySet) List() []string {    fmt.Printf("DEJDEJ id:",3120)
...
func (s *LargeCommunitySet) ToConfig() *config.LargeCommunitySet {    fmt.Printf("DEJDEJ id:",3121)
...
func (s *LargeCommunitySet) String() string {    fmt.Printf("DEJDEJ id:",3122)

	return strings.Join(s.List(), "\n")
}

func (s *LargeCommunitySet) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3123)

	return json.Marshal(s.ToConfig())
}

func ParseLargeCommunityRegexp(arg string) (*regexp.Regexp, error) {    fmt.Printf("DEJDEJ id:",3124)
...
func NewLargeCommunitySet(c config.LargeCommunitySet) (*LargeCommunitySet, error) {    fmt.Printf("DEJDEJ id:",3125)
...
func (c *PrefixCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3126)

	return CONDITION_PREFIX
}

func (c *PrefixCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3127)

	return c.set
}

func (c *PrefixCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3128)
...
func (c *PrefixCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3129)
...
func (c *PrefixCondition) Name() string {    fmt.Printf("DEJDEJ id:",3130)
 return c.set.name }

func NewPrefixCondition(c config.MatchPrefixSet) (*PrefixCondition, error) {    fmt.Printf("DEJDEJ id:",3131)
...
func (c *NeighborCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3132)

	return CONDITION_NEIGHBOR
}

func (c *NeighborCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3133)

	return c.set
}

func (c *NeighborCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3134)
...
func (c *NeighborCondition) Evaluate(path *Path, options *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3135)
...
func (c *NeighborCondition) Name() string {    fmt.Printf("DEJDEJ id:",3136)
 return c.set.name }

func NewNeighborCondition(c config.MatchNeighborSet) (*NeighborCondition, error) {    fmt.Printf("DEJDEJ id:",3137)
...
func (c *AsPathCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3138)

	return CONDITION_AS_PATH
}

func (c *AsPathCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3139)

	return c.set
}

func (c *AsPathCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3140)

	return c.option
}

func (c *AsPathCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3141)
...
func (c *AsPathCondition) Name() string {    fmt.Printf("DEJDEJ id:",3142)
 return c.set.name }

func NewAsPathCondition(c config.MatchAsPathSet) (*AsPathCondition, error) {    fmt.Printf("DEJDEJ id:",3143)
...
func (c *CommunityCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3144)

	return CONDITION_COMMUNITY
}

func (c *CommunityCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3145)

	return c.set
}

func (c *CommunityCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3146)

	return c.option
}

func (c *CommunityCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3147)
...
func (c *CommunityCondition) Name() string {    fmt.Printf("DEJDEJ id:",3148)
 return c.set.name }

func NewCommunityCondition(c config.MatchCommunitySet) (*CommunityCondition, error) {    fmt.Printf("DEJDEJ id:",3149)
...
func (c *ExtCommunityCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3150)

	return CONDITION_EXT_COMMUNITY
}

func (c *ExtCommunityCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3151)

	return c.set
}

func (c *ExtCommunityCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3152)

	return c.option
}

func (c *ExtCommunityCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3153)
...
func (c *ExtCommunityCondition) Name() string {    fmt.Printf("DEJDEJ id:",3154)
 return c.set.name }

func NewExtCommunityCondition(c config.MatchExtCommunitySet) (*ExtCommunityCondition, error) {    fmt.Printf("DEJDEJ id:",3155)
...
func (c *LargeCommunityCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3156)

	return CONDITION_LARGE_COMMUNITY
}

func (c *LargeCommunityCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3157)

	return c.set
}

func (c *LargeCommunityCondition) Option() MatchOption {    fmt.Printf("DEJDEJ id:",3158)

	return c.option
}

func (c *LargeCommunityCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3159)
...
func (c *LargeCommunityCondition) Name() string {    fmt.Printf("DEJDEJ id:",3160)
 return c.set.name }

func NewLargeCommunityCondition(c config.MatchLargeCommunitySet) (*LargeCommunityCondition, error) {    fmt.Printf("DEJDEJ id:",3161)
...
func (c *AsPathLengthCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3162)
...
func (c *AsPathLengthCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3163)
...
func (c *AsPathLengthCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3164)

	return nil
}

func (c *AsPathLengthCondition) Name() string {    fmt.Printf("DEJDEJ id:",3165)
 return "" }

func (c *AsPathLengthCondition) String() string {    fmt.Printf("DEJDEJ id:",3166)

	return fmt.Sprintf("%s%d", c.operator, c.length)
}

func NewAsPathLengthCondition(c config.AsPathLength) (*AsPathLengthCondition, error) {    fmt.Printf("DEJDEJ id:",3167)
...
func (c *RpkiValidationCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3168)

	return CONDITION_RPKI
}

func (c *RpkiValidationCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3169)

	return c.result == path.ValidationStatus()
}

func (c *RpkiValidationCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3170)

	return nil
}

func (c *RpkiValidationCondition) Name() string {    fmt.Printf("DEJDEJ id:",3171)
 return "" }

func (c *RpkiValidationCondition) String() string {    fmt.Printf("DEJDEJ id:",3172)

	return string(c.result)
}

func NewRpkiValidationCondition(c config.RpkiValidationResultType) (*RpkiValidationCondition, error) {    fmt.Printf("DEJDEJ id:",3173)
...
func (c *RouteTypeCondition) Type() ConditionType {    fmt.Printf("DEJDEJ id:",3174)

	return CONDITION_ROUTE_TYPE
}

func (c *RouteTypeCondition) Evaluate(path *Path, _ *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3175)
...
func (c *RouteTypeCondition) Set() DefinedSet {    fmt.Printf("DEJDEJ id:",3176)

	return nil
}

func (c *RouteTypeCondition) Name() string {    fmt.Printf("DEJDEJ id:",3177)
 return "" }

func (c *RouteTypeCondition) String() string {    fmt.Printf("DEJDEJ id:",3178)

	return string(c.typ)
}

func NewRouteTypeCondition(c config.RouteType) (*RouteTypeCondition, error) {    fmt.Printf("DEJDEJ id:",3179)
...
func (a *RoutingAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3180)

	return ACTION_ROUTING
}

func (a *RoutingAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3181)
...
func (a *RoutingAction) String() string {    fmt.Printf("DEJDEJ id:",3182)
...
func NewRoutingAction(c config.RouteDisposition) (*RoutingAction, error) {    fmt.Printf("DEJDEJ id:",3183)
...
func RegexpRemoveCommunities(path *Path, exps []*regexp.Regexp) {    fmt.Printf("DEJDEJ id:",3184)
...
func RegexpRemoveExtCommunities(path *Path, exps []*regexp.Regexp, subtypes []bgp.ExtendedCommunityAttrSubType) {    fmt.Printf("DEJDEJ id:",3185)
...
func RegexpRemoveLargeCommunities(path *Path, exps []*regexp.Regexp) {    fmt.Printf("DEJDEJ id:",3186)
...
func (a *CommunityAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3187)

	return ACTION_COMMUNITY
}

func (a *CommunityAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3188)
...
func (a *CommunityAction) ToConfig() *config.SetCommunity {    fmt.Printf("DEJDEJ id:",3189)
...
func (a *CommunityAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3190)

	return json.Marshal(a.ToConfig())
}

func (a *CommunityAction) String() string {    fmt.Printf("DEJDEJ id:",3191)
...
func NewCommunityAction(c config.SetCommunity) (*CommunityAction, error) {    fmt.Printf("DEJDEJ id:",3192)
...
func (a *ExtCommunityAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3193)

	return ACTION_EXT_COMMUNITY
}

func (a *ExtCommunityAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3194)
...
func (a *ExtCommunityAction) ToConfig() *config.SetExtCommunity {    fmt.Printf("DEJDEJ id:",3195)
...
func (a *ExtCommunityAction) String() string {    fmt.Printf("DEJDEJ id:",3196)
...
func (a *ExtCommunityAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3197)

	return json.Marshal(a.ToConfig())
}

func NewExtCommunityAction(c config.SetExtCommunity) (*ExtCommunityAction, error) {    fmt.Printf("DEJDEJ id:",3198)
...
func (a *LargeCommunityAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3199)

	return ACTION_LARGE_COMMUNITY
}

func (a *LargeCommunityAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3200)
...
func (a *LargeCommunityAction) ToConfig() *config.SetLargeCommunity {    fmt.Printf("DEJDEJ id:",3201)
...
func (a *LargeCommunityAction) String() string {    fmt.Printf("DEJDEJ id:",3202)
...
func (a *LargeCommunityAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3203)

	return json.Marshal(a.ToConfig())
}

func NewLargeCommunityAction(c config.SetLargeCommunity) (*LargeCommunityAction, error) {    fmt.Printf("DEJDEJ id:",3204)
...
func (a *MedAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3205)

	return ACTION_MED
}

func (a *MedAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3206)
...
func (a *MedAction) ToConfig() config.BgpSetMedType {    fmt.Printf("DEJDEJ id:",3207)
...
func (a *MedAction) String() string {    fmt.Printf("DEJDEJ id:",3208)

	return string(a.ToConfig())
}

func (a *MedAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3209)

	return json.Marshal(a.ToConfig())
}

func NewMedAction(c config.BgpSetMedType) (*MedAction, error) {    fmt.Printf("DEJDEJ id:",3210)
...
func NewMedActionFromApiStruct(action MedActionType, value int64) *MedAction {    fmt.Printf("DEJDEJ id:",3211)
...
func (a *LocalPrefAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3212)

	return ACTION_LOCAL_PREF
}

func (a *LocalPrefAction) Apply(path *Path, _ *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3213)

	path.setPathAttr(bgp.NewPathAttributeLocalPref(a.value))
	return path
}

func (a *LocalPrefAction) ToConfig() uint32 {    fmt.Printf("DEJDEJ id:",3214)

	return a.value
}

func (a *LocalPrefAction) String() string {    fmt.Printf("DEJDEJ id:",3215)

	return fmt.Sprintf("%d", a.value)
}

func (a *LocalPrefAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3216)

	return json.Marshal(a.ToConfig())
}

func NewLocalPrefAction(value uint32) (*LocalPrefAction, error) {    fmt.Printf("DEJDEJ id:",3217)
...
func (a *AsPathPrependAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3218)

	return ACTION_AS_PATH_PREPEND
}

func (a *AsPathPrependAction) Apply(path *Path, option *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3219)
...
func (a *AsPathPrependAction) ToConfig() *config.SetAsPathPrepend {    fmt.Printf("DEJDEJ id:",3220)
...
func (a *AsPathPrependAction) String() string {    fmt.Printf("DEJDEJ id:",3221)

	c := a.ToConfig()
	return fmt.Sprintf("prepend %s %d times", c.As, c.RepeatN)
}

func (a *AsPathPrependAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3222)
...
func NewAsPathPrependAction(action config.SetAsPathPrepend) (*AsPathPrependAction, error) {    fmt.Printf("DEJDEJ id:",3223)
...
func (a *NexthopAction) Type() ActionType {    fmt.Printf("DEJDEJ id:",3224)

	return ACTION_NEXTHOP
}

func (a *NexthopAction) Apply(path *Path, options *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3225)
...
func (a *NexthopAction) ToConfig() config.BgpNextHopType {    fmt.Printf("DEJDEJ id:",3226)
...
func (a *NexthopAction) String() string {    fmt.Printf("DEJDEJ id:",3227)

	return string(a.ToConfig())
}

func (a *NexthopAction) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3228)

	return json.Marshal(a.ToConfig())
}

func NewNexthopAction(c config.BgpNextHopType) (*NexthopAction, error) {    fmt.Printf("DEJDEJ id:",3229)
...
func (s *Statement) Evaluate(p *Path, options *PolicyOptions) bool {    fmt.Printf("DEJDEJ id:",3230)
...
func (s *Statement) Apply(path *Path, options *PolicyOptions) (RouteType, *Path) {    fmt.Printf("DEJDEJ id:",3231)
...
func (s *Statement) ToConfig() *config.Statement {    fmt.Printf("DEJDEJ id:",3232)
...
func (s *Statement) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3233)
...
func (lhs *Statement) mod(op opType, rhs *Statement) error {    fmt.Printf("DEJDEJ id:",3234)
...
func (lhs *Statement) Add(rhs *Statement) error {    fmt.Printf("DEJDEJ id:",3235)

	return lhs.mod(ADD, rhs)
}

func (lhs *Statement) Remove(rhs *Statement) error {    fmt.Printf("DEJDEJ id:",3236)

	return lhs.mod(REMOVE, rhs)
}

func (lhs *Statement) Replace(rhs *Statement) error {    fmt.Printf("DEJDEJ id:",3237)

	return lhs.mod(REPLACE, rhs)
}

func NewStatement(c config.Statement) (*Statement, error) {    fmt.Printf("DEJDEJ id:",3238)
...
func (p *Policy) Apply(path *Path, options *PolicyOptions) (RouteType, *Path) {    fmt.Printf("DEJDEJ id:",3239)
...
func (p *Policy) ToConfig() *config.PolicyDefinition {    fmt.Printf("DEJDEJ id:",3240)
...
func (p *Policy) FillUp(m map[string]*Statement) error {    fmt.Printf("DEJDEJ id:",3241)
...
func (lhs *Policy) Add(rhs *Policy) error {    fmt.Printf("DEJDEJ id:",3242)

	lhs.Statements = append(lhs.Statements, rhs.Statements...)
	return nil
}

func (lhs *Policy) Remove(rhs *Policy) error {    fmt.Printf("DEJDEJ id:",3243)
...
func (lhs *Policy) Replace(rhs *Policy) error {    fmt.Printf("DEJDEJ id:",3244)

	lhs.Statements = rhs.Statements
	return nil
}

func (p *Policy) MarshalJSON() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3245)

	return json.Marshal(p.ToConfig())
}

func NewPolicy(c config.PolicyDefinition) (*Policy, error) {    fmt.Printf("DEJDEJ id:",3246)
...
func (p Policies) Len() int {    fmt.Printf("DEJDEJ id:",3247)

	return len(p)
}

func (p Policies) Swap(i, j int) {    fmt.Printf("DEJDEJ id:",3248)

	p[i], p[j] = p[j], p[i]
}

func (p Policies) Less(i, j int) bool {    fmt.Printf("DEJDEJ id:",3249)
...
func (r *RoutingPolicy) ApplyPolicy(id string, dir PolicyDirection, before *Path, options *PolicyOptions) *Path {    fmt.Printf("DEJDEJ id:",3250)
...
func (r *RoutingPolicy) getPolicy(id string, dir PolicyDirection) []*Policy {    fmt.Printf("DEJDEJ id:",3251)
...
func (r *RoutingPolicy) getDefaultPolicy(id string, dir PolicyDirection) RouteType {    fmt.Printf("DEJDEJ id:",3252)
...
func (r *RoutingPolicy) setPolicy(id string, dir PolicyDirection, policies []*Policy) error {    fmt.Printf("DEJDEJ id:",3253)
...
func (r *RoutingPolicy) setDefaultPolicy(id string, dir PolicyDirection, typ RouteType) error {    fmt.Printf("DEJDEJ id:",3254)
...
func (r *RoutingPolicy) getAssignmentFromConfig(dir PolicyDirection, a config.ApplyPolicy) ([]*Policy, RouteType, error) {    fmt.Printf("DEJDEJ id:",3255)
...
func (r *RoutingPolicy) validateCondition(v Condition) (err error) {    fmt.Printf("DEJDEJ id:",3256)
...
func (r *RoutingPolicy) inUse(d DefinedSet) bool {    fmt.Printf("DEJDEJ id:",3257)
...
func (r *RoutingPolicy) statementInUse(x *Statement) bool {    fmt.Printf("DEJDEJ id:",3258)
...
func (r *RoutingPolicy) reload(c config.RoutingPolicy) error {    fmt.Printf("DEJDEJ id:",3259)
...
func (r *RoutingPolicy) GetDefinedSet(typ DefinedType, name string) (*config.DefinedSets, error) {    fmt.Printf("DEJDEJ id:",3260)
...
func (r *RoutingPolicy) AddDefinedSet(s DefinedSet) error {    fmt.Printf("DEJDEJ id:",3261)
...
func (r *RoutingPolicy) DeleteDefinedSet(a DefinedSet, all bool) (err error) {    fmt.Printf("DEJDEJ id:",3262)
...
func (r *RoutingPolicy) ReplaceDefinedSet(a DefinedSet) (err error) {    fmt.Printf("DEJDEJ id:",3263)
...
func (r *RoutingPolicy) GetStatement() []*config.Statement {    fmt.Printf("DEJDEJ id:",3264)
...
func (r *RoutingPolicy) AddStatement(st *Statement) (err error) {    fmt.Printf("DEJDEJ id:",3265)
...
func (r *RoutingPolicy) DeleteStatement(st *Statement, all bool) (err error) {    fmt.Printf("DEJDEJ id:",3266)
...
func (r *RoutingPolicy) ReplaceStatement(st *Statement) (err error) {    fmt.Printf("DEJDEJ id:",3267)
...
func (r *RoutingPolicy) GetAllPolicy() []*config.PolicyDefinition {    fmt.Printf("DEJDEJ id:",3268)
...
func (r *RoutingPolicy) AddPolicy(x *Policy, refer bool) (err error) {    fmt.Printf("DEJDEJ id:",3269)
...
func (r *RoutingPolicy) DeletePolicy(x *Policy, all, preserve bool, activeId []string) (err error) {    fmt.Printf("DEJDEJ id:",3270)
...
func (r *RoutingPolicy) ReplacePolicy(x *Policy, refer, preserve bool) (err error) {    fmt.Printf("DEJDEJ id:",3271)
...
func (r *RoutingPolicy) GetPolicyAssignment(id string, dir PolicyDirection) (RouteType, []*config.PolicyDefinition, error) {    fmt.Printf("DEJDEJ id:",3272)
...
func (r *RoutingPolicy) AddPolicyAssignment(id string, dir PolicyDirection, policies []*config.PolicyDefinition, def RouteType) (err error) {    fmt.Printf("DEJDEJ id:",3273)
...
func (r *RoutingPolicy) DeletePolicyAssignment(id string, dir PolicyDirection, policies []*config.PolicyDefinition, all bool) (err error) {    fmt.Printf("DEJDEJ id:",3274)
...
func (r *RoutingPolicy) ReplacePolicyAssignment(id string, dir PolicyDirection, policies []*config.PolicyDefinition, def RouteType) (err error) {    fmt.Printf("DEJDEJ id:",3275)
...
func (r *RoutingPolicy) Reset(rp *config.RoutingPolicy, ap map[string]config.ApplyPolicy) error {    fmt.Printf("DEJDEJ id:",3276)
...
func NewRoutingPolicy() *RoutingPolicy {    fmt.Printf("DEJDEJ id:",3277)
...
func CanImportToVrf(v *Vrf, path *Path) bool {    fmt.Printf("DEJDEJ id:",3278)
