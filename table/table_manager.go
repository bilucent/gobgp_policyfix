...
func ProcessMessage(m *bgp.BGPMessage, peerInfo *PeerInfo, timestamp time.Time) []*Path {    fmt.Printf("DEJDEJ id:",2818)
...
func NewTableManager(rfList []bgp.RouteFamily) *TableManager {    fmt.Printf("DEJDEJ id:",2819)
...
func (manager *TableManager) GetRFlist() []bgp.RouteFamily {    fmt.Printf("DEJDEJ id:",2820)

	return manager.rfList
}

func (manager *TableManager) AddVrf(name string, id uint32, rd bgp.RouteDistinguisherInterface, importRt, exportRt []bgp.ExtendedCommunityInterface, info *PeerInfo) ([]*Path, error) {    fmt.Printf("DEJDEJ id:",2821)
...
func (manager *TableManager) DeleteVrf(name string) ([]*Path, error) {    fmt.Printf("DEJDEJ id:",2822)
...
func (manager *TableManager) calculate(dsts []*Destination) []*Destination {    fmt.Printf("DEJDEJ id:",2823)
...
func (manager *TableManager) DeletePathsByPeer(info *PeerInfo, rf bgp.RouteFamily) []*Destination {    fmt.Printf("DEJDEJ id:",2824)
...
func (manager *TableManager) ProcessPaths(pathList []*Path) []*Destination {    fmt.Printf("DEJDEJ id:",2825)
...
// Advertisement route.
func (manager *TableManager) handleMacMobility(path *Path) []*Destination {    fmt.Printf("DEJDEJ id:",2826)
...
func (manager *TableManager) tables(list ...bgp.RouteFamily) []*Table {    fmt.Printf("DEJDEJ id:",2827)
...
func (manager *TableManager) getDestinationCount(rfList []bgp.RouteFamily) int {    fmt.Printf("DEJDEJ id:",2828)
...
func (manager *TableManager) GetBestPathList(id string, rfList []bgp.RouteFamily) []*Path {    fmt.Printf("DEJDEJ id:",2829)
...
func (manager *TableManager) GetBestMultiPathList(id string, rfList []bgp.RouteFamily) [][]*Path {    fmt.Printf("DEJDEJ id:",2830)
...
func (manager *TableManager) GetPathList(id string, rfList []bgp.RouteFamily) []*Path {    fmt.Printf("DEJDEJ id:",2831)
...
func (manager *TableManager) GetPathListWithNexthop(id string, rfList []bgp.RouteFamily, nexthop net.IP) []*Path {    fmt.Printf("DEJDEJ id:",2832)
...
func (manager *TableManager) GetDestination(path *Path) *Destination {    fmt.Printf("DEJDEJ id:",2833)
...
func (manager *TableManager) TableInfo(id string, family bgp.RouteFamily) (*TableInfo, error) {    fmt.Printf("DEJDEJ id:",2834)
