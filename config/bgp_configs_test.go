...
func TestEqual(t *testing.T) {    fmt.Printf("DEJDEJ id:",3283)
...
func extractTomlFromMarkdown(fileMd string, fileToml string) error {    fmt.Printf("DEJDEJ id:",3284)
...
func TestConfigExample(t *testing.T) {    fmt.Printf("DEJDEJ id:",3285)
