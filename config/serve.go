...
func ReadConfigfileServe(path, format string, configCh chan *BgpConfigSet) {    fmt.Printf("DEJDEJ id:",3457)
...
func ConfigSetToRoutingPolicy(c *BgpConfigSet) *RoutingPolicy {    fmt.Printf("DEJDEJ id:",3458)
...
func UpdatePeerGroupConfig(curC, newC *BgpConfigSet) ([]PeerGroup, []PeerGroup, []PeerGroup) {    fmt.Printf("DEJDEJ id:",3459)
...
func UpdateNeighborConfig(curC, newC *BgpConfigSet) ([]Neighbor, []Neighbor, []Neighbor) {    fmt.Printf("DEJDEJ id:",3460)
...
func CheckPolicyDifference(currentPolicy *RoutingPolicy, newPolicy *RoutingPolicy) bool {    fmt.Printf("DEJDEJ id:",3461)
