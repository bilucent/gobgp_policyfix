...
func detectConfigFileType(path, def string) string {    fmt.Printf("DEJDEJ id:",3473)
...
func extractArray(intf interface{    fmt.Printf("DEJDEJ id:",3474)
}) ([]interface{    fmt.Printf("DEJDEJ id:",3474)
}, error) {    fmt.Printf("DEJDEJ id:",3474)
...
func getIPv6LinkLocalAddress(ifname string) (string, error) {    fmt.Printf("DEJDEJ id:",3475)
...
func isLocalLinkLocalAddress(ifindex int, addr net.IP) (bool, error) {    fmt.Printf("DEJDEJ id:",3476)
...
func (b *BgpConfigSet) getPeerGroup(n string) (*PeerGroup, error) {    fmt.Printf("DEJDEJ id:",3477)
...
func (d *DynamicNeighbor) validate(b *BgpConfigSet) error {    fmt.Printf("DEJDEJ id:",3478)
...
func (n *Neighbor) IsConfederationMember(g *Global) bool {    fmt.Printf("DEJDEJ id:",3479)
...
func (n *Neighbor) IsConfederation(g *Global) bool {    fmt.Printf("DEJDEJ id:",3480)
...
func (n *Neighbor) IsEBGPPeer(g *Global) bool {    fmt.Printf("DEJDEJ id:",3481)

	return n.Config.PeerAs != g.Config.As
}

func (n *Neighbor) CreateRfMap() map[bgp.RouteFamily]bgp.BGPAddPathMode {    fmt.Printf("DEJDEJ id:",3482)
...
func (n *Neighbor) GetAfiSafi(family bgp.RouteFamily) *AfiSafi {    fmt.Printf("DEJDEJ id:",3483)
...
func (n *Neighbor) ExtractNeighborAddress() (string, error) {    fmt.Printf("DEJDEJ id:",3484)
...
func (n *Neighbor) IsAddPathReceiveEnabled(family bgp.RouteFamily) bool {    fmt.Printf("DEJDEJ id:",3485)
...
func (c AfiSafis) ToRfList() ([]bgp.RouteFamily, error) {    fmt.Printf("DEJDEJ id:",3486)
...
func inSlice(n Neighbor, b []Neighbor) int {    fmt.Printf("DEJDEJ id:",3487)
...
func existPeerGroup(n string, b []PeerGroup) int {    fmt.Printf("DEJDEJ id:",3488)
...
func CheckAfiSafisChange(x, y []AfiSafi) bool {    fmt.Printf("DEJDEJ id:",3489)
...
func ParseMaskLength(prefix, mask string) (int, int, error) {    fmt.Printf("DEJDEJ id:",3490)
