...
func Test_Header(t *testing.T) {    fmt.Printf("DEJDEJ id:",3501)
...
func Test_InterfaceUpdateBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3502)
...
func Test_InterfaceAddressUpdateBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3503)
...
func Test_RouterIDUpdateBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3504)
...
func Test_IPRouteBody_IPv4(t *testing.T) {    fmt.Printf("DEJDEJ id:",3505)
...
func Test_IPRouteBody_IPv6(t *testing.T) {    fmt.Printf("DEJDEJ id:",3506)
...
func Test_NexthopLookupBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3507)
...
func Test_ImportLookupBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3508)
...
func Test_NexthopRegisterBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3509)
...
func Test_NexthopUpdateBody(t *testing.T) {    fmt.Printf("DEJDEJ id:",3510)
