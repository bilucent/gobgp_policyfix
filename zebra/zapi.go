...
func HeaderSize(version uint8) uint16 {    fmt.Printf("DEJDEJ id:",3512)
...
func (t INTERFACE_STATUS) String() string {    fmt.Printf("DEJDEJ id:",3513)
...
func (t INTERFACE_ADDRESS_FLAG) String() string {    fmt.Printf("DEJDEJ id:",3514)
...
func RouteTypeFromString(typ string) (ROUTE_TYPE, error) {    fmt.Printf("DEJDEJ id:",3515)
...
func (t MESSAGE_FLAG) String() string {    fmt.Printf("DEJDEJ id:",3516)
...
func (t FLAG) String() string {    fmt.Printf("DEJDEJ id:",3517)
...
func NewClient(network, address string, typ ROUTE_TYPE, version uint8) (*Client, error) {    fmt.Printf("DEJDEJ id:",3518)
...
func readAll(conn net.Conn, length int) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3519)
...
func (c *Client) Receive() chan *Message {    fmt.Printf("DEJDEJ id:",3520)

	return c.incoming
}

func (c *Client) Send(m *Message) {    fmt.Printf("DEJDEJ id:",3521)
...
func (c *Client) SendCommand(command API_TYPE, vrfId uint16, body Body) error {    fmt.Printf("DEJDEJ id:",3522)
...
func (c *Client) SendHello() error {    fmt.Printf("DEJDEJ id:",3523)
...
func (c *Client) SendRouterIDAdd() error {    fmt.Printf("DEJDEJ id:",3524)
...
func (c *Client) SendInterfaceAdd() error {    fmt.Printf("DEJDEJ id:",3525)
...
func (c *Client) SendRedistribute(t ROUTE_TYPE, vrfId uint16) error {    fmt.Printf("DEJDEJ id:",3526)
...
func (c *Client) SendRedistributeDelete(t ROUTE_TYPE) error {    fmt.Printf("DEJDEJ id:",3527)
...
func (c *Client) SendIPRoute(vrfId uint16, body *IPRouteBody, isWithdraw bool) error {    fmt.Printf("DEJDEJ id:",3528)
...
func (c *Client) SendNexthopRegister(vrfId uint16, body *NexthopRegisterBody, isWithdraw bool) error {    fmt.Printf("DEJDEJ id:",3529)
...
func (c *Client) Close() error {    fmt.Printf("DEJDEJ id:",3530)
...
func (h *Header) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3531)
...
func (h *Header) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",3532)
...
func (b *UnknownBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3533)

	b.Data = data
	return nil
}

func (b *UnknownBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3534)

	return b.Data, nil
}

func (b *UnknownBody) String() string {    fmt.Printf("DEJDEJ id:",3535)
...
func (b *HelloBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3536)
...
func (b *HelloBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3537)
...
func (b *HelloBody) String() string {    fmt.Printf("DEJDEJ id:",3538)
...
func (b *RedistributeBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3539)
...
func (b *RedistributeBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3540)
...
func (b *RedistributeBody) String() string {    fmt.Printf("DEJDEJ id:",3541)
...
func (b *InterfaceUpdateBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3542)
...
func (b *InterfaceUpdateBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3543)

	return []byte{}, nil
}

func (b *InterfaceUpdateBody) String() string {    fmt.Printf("DEJDEJ id:",3544)
...
func (b *InterfaceAddressUpdateBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3545)
...
func (b *InterfaceAddressUpdateBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3546)

	return []byte{}, nil
}

func (b *InterfaceAddressUpdateBody) String() string {    fmt.Printf("DEJDEJ id:",3547)
...
func (b *RouterIDUpdateBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3548)
...
func (b *RouterIDUpdateBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3549)

	return []byte{}, nil
}

func (b *RouterIDUpdateBody) String() string {    fmt.Printf("DEJDEJ id:",3550)
...
func (b *IPRouteBody) RouteFamily() bgp.RouteFamily {    fmt.Printf("DEJDEJ id:",3551)
...
func (b *IPRouteBody) IsWithdraw() bool {    fmt.Printf("DEJDEJ id:",3552)
...
func (b *IPRouteBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3553)
...
func (b *IPRouteBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3554)
...
func (b *IPRouteBody) String() string {    fmt.Printf("DEJDEJ id:",3555)
...
func (n *Nexthop) String() string {    fmt.Printf("DEJDEJ id:",3556)
...
func serializeNexthops(nexthops []*Nexthop, isV4 bool, version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3557)
...
func decodeNexthopsFromBytes(nexthops *[]*Nexthop, data []byte, isV4 bool, version uint8) (int, error) {    fmt.Printf("DEJDEJ id:",3558)
...
func (b *NexthopLookupBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3559)
...
func (b *NexthopLookupBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3560)
...
func (b *NexthopLookupBody) String() string {    fmt.Printf("DEJDEJ id:",3561)
...
func (b *ImportLookupBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3562)
...
func (b *ImportLookupBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3563)
...
func (b *ImportLookupBody) String() string {    fmt.Printf("DEJDEJ id:",3564)
...
func (n *RegisteredNexthop) Len() int {    fmt.Printf("DEJDEJ id:",3565)
...
func (n *RegisteredNexthop) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3566)
...
func (n *RegisteredNexthop) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",3567)
...
func (n *RegisteredNexthop) String() string {    fmt.Printf("DEJDEJ id:",3568)
...
func (b *NexthopRegisterBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3569)
...
func (b *NexthopRegisterBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3570)
...
func (b *NexthopRegisterBody) String() string {    fmt.Printf("DEJDEJ id:",3571)
...
func (b *NexthopUpdateBody) Serialize(version uint8) ([]byte, error) {    fmt.Printf("DEJDEJ id:",3572)
...
func (b *NexthopUpdateBody) DecodeFromBytes(data []byte, version uint8) error {    fmt.Printf("DEJDEJ id:",3573)
...
func (b *NexthopUpdateBody) String() string {    fmt.Printf("DEJDEJ id:",3574)
...
func (m *Message) Serialize() ([]byte, error) {    fmt.Printf("DEJDEJ id:",3575)
...
func (m *Message) parseMessage(data []byte) error {    fmt.Printf("DEJDEJ id:",3576)
...
func (m *Message) parseFrrMessage(data []byte) error {    fmt.Printf("DEJDEJ id:",3577)
...
func ParseMessage(hdr *Header, data []byte) (m *Message, err error) {    fmt.Printf("DEJDEJ id:",3578)
