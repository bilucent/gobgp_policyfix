...
func NewMockConnection(t *testing.T) *MockConnection {    fmt.Printf("DEJDEJ id:",96)
...
func (m *MockConnection) SetWriteDeadline(t time.Time) error {    fmt.Printf("DEJDEJ id:",97)

	return nil
}

func (m *MockConnection) setData(data []byte) int {    fmt.Printf("DEJDEJ id:",98)
...
func (m *MockConnection) Read(buf []byte) (int, error) {    fmt.Printf("DEJDEJ id:",99)
...
func (m *MockConnection) Write(buf []byte) (int, error) {    fmt.Printf("DEJDEJ id:",100)
...
func showMessageType(t uint8) string {    fmt.Printf("DEJDEJ id:",101)
...
func (m *MockConnection) Close() error {    fmt.Printf("DEJDEJ id:",102)
...
func (m *MockConnection) LocalAddr() net.Addr {    fmt.Printf("DEJDEJ id:",103)
...
func TestReadAll(t *testing.T) {    fmt.Printf("DEJDEJ id:",104)
...
func TestFSMHandlerOpensent_HoldTimerExpired(t *testing.T) {    fmt.Printf("DEJDEJ id:",105)
...
func TestFSMHandlerOpenconfirm_HoldTimerExpired(t *testing.T) {    fmt.Printf("DEJDEJ id:",106)
...
func TestFSMHandlerEstablish_HoldTimerExpired(t *testing.T) {    fmt.Printf("DEJDEJ id:",107)
...
func TestFSMHandlerOpenconfirm_HoldtimeZero(t *testing.T) {    fmt.Printf("DEJDEJ id:",108)
...
func TestFSMHandlerEstablished_HoldtimeZero(t *testing.T) {    fmt.Printf("DEJDEJ id:",109)
...
func TestCheckOwnASLoop(t *testing.T) {    fmt.Printf("DEJDEJ id:",110)
...
func makePeerAndHandler() (*Peer, *FSMHandler) {    fmt.Printf("DEJDEJ id:",111)
...
func open() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",112)
...
func keepalive() *bgp.BGPMessage {    fmt.Printf("DEJDEJ id:",113)
