...
func (m *mrtWriter) Stop() {    fmt.Printf("DEJDEJ id:",259)

	close(m.dead)
}

func (m *mrtWriter) loop() error {    fmt.Printf("DEJDEJ id:",260)
...
func mrtFileOpen(filename string, interval uint64) (*os.File, error) {    fmt.Printf("DEJDEJ id:",261)
...
func newMrtWriter(s *BgpServer, c *config.MrtConfig, rInterval, dInterval uint64) (*mrtWriter, error) {    fmt.Printf("DEJDEJ id:",262)
...
func (m *mrtManager) enable(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",263)
...
func (m *mrtManager) disable(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",264)
...
func newMrtManager(s *BgpServer) *mrtManager {    fmt.Printf("DEJDEJ id:",265)
