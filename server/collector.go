...
func (c *Collector) writePoints(points []*client.Point) error {    fmt.Printf("DEJDEJ id:",59)
...
func (c *Collector) writePeer(msg *WatchEventPeerState) error {    fmt.Printf("DEJDEJ id:",60)
...
func path2data(path *table.Path) (map[string]interface{    fmt.Printf("DEJDEJ id:",61)
}, map[string]string) {    fmt.Printf("DEJDEJ id:",61)
...
func (c *Collector) writeUpdate(msg *WatchEventUpdate) error {    fmt.Printf("DEJDEJ id:",62)
...
func (c *Collector) writeTable(msg *WatchEventAdjIn) error {    fmt.Printf("DEJDEJ id:",63)
...
func (c *Collector) loop() {    fmt.Printf("DEJDEJ id:",64)
...
func NewCollector(s *BgpServer, url, dbName string, interval uint64) (*Collector, error) {    fmt.Printf("DEJDEJ id:",65)
