...
func (s *sadbMsg) DecodeFromBytes(data []byte) error {    fmt.Printf("DEJDEJ id:",79)
...
func newSockaddrIn(addr string) sockaddrIn {    fmt.Printf("DEJDEJ id:",80)
...
func roundUp(v int) int {    fmt.Printf("DEJDEJ id:",81)
...
func b(p unsafe.Pointer, length int) []byte {    fmt.Printf("DEJDEJ id:",82)
...
func pfkeyReply() (spi uint32, err error) {    fmt.Printf("DEJDEJ id:",83)
...
func sendSadbMsg(msg *sadbMsg, body []byte) (err error) {    fmt.Printf("DEJDEJ id:",84)
...
func rfkeyRequest(msgType uint8, src, dst string, spi uint32, key string) error {    fmt.Printf("DEJDEJ id:",85)
...
func saAdd(address, key string) error {    fmt.Printf("DEJDEJ id:",86)
...
func saDelete(address string) error {    fmt.Printf("DEJDEJ id:",87)
...
func setsockoptTcpMD5Sig(fd int, address string, key string) error {    fmt.Printf("DEJDEJ id:",88)
...
func SetTcpMD5SigSockopt(l *net.TCPListener, address string, key string) error {    fmt.Printf("DEJDEJ id:",89)
...
func setsockoptIpTtl(fd int, family int, value int) error {    fmt.Printf("DEJDEJ id:",90)
...
func SetListenTcpTTLSockopt(l *net.TCPListener, ttl int) error {    fmt.Printf("DEJDEJ id:",91)
...
func SetTcpTTLSockopt(conn *net.TCPConn, ttl int) error {    fmt.Printf("DEJDEJ id:",92)
...
func setsockoptIpMinTtl(fd int, family int, value int) error {    fmt.Printf("DEJDEJ id:",93)
...
func SetTcpMinTTLSockopt(conn *net.TCPConn, ttl int) error {    fmt.Printf("DEJDEJ id:",94)
...
func (d *TCPDialer) DialTCP(addr string, port int) (*net.TCPConn, error) {    fmt.Printf("DEJDEJ id:",95)
