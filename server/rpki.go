...
func before(a, b uint32) bool {    fmt.Printf("DEJDEJ id:",334)
...
func (r *RoaBucket) GetEntries() []*table.ROA {    fmt.Printf("DEJDEJ id:",335)
...
func (r roas) Len() int {    fmt.Printf("DEJDEJ id:",336)

	return len(r)
}

func (r roas) Swap(i, j int) {    fmt.Printf("DEJDEJ id:",337)

	r[i], r[j] = r[j], r[i]
}

func (r roas) Less(i, j int) bool {    fmt.Printf("DEJDEJ id:",338)
...
func NewROAManager(as uint32) (*roaManager, error) {    fmt.Printf("DEJDEJ id:",339)
...
func (m *roaManager) SetAS(as uint32) error {    fmt.Printf("DEJDEJ id:",340)
...
func (m *roaManager) AddServer(host string, lifetime int64) error {    fmt.Printf("DEJDEJ id:",341)
...
func (m *roaManager) DeleteServer(host string) error {    fmt.Printf("DEJDEJ id:",342)
...
func (m *roaManager) deleteAllROA(network string) {    fmt.Printf("DEJDEJ id:",343)
...
func (m *roaManager) Enable(address string) error {    fmt.Printf("DEJDEJ id:",344)
...
func (m *roaManager) Disable(address string) error {    fmt.Printf("DEJDEJ id:",345)
...
func (m *roaManager) Reset(address string) error {    fmt.Printf("DEJDEJ id:",346)

	return m.Disable(address)
}

func (m *roaManager) SoftReset(address string) error {    fmt.Printf("DEJDEJ id:",347)
...
func (c *roaManager) ReceiveROA() chan *ROAEvent {    fmt.Printf("DEJDEJ id:",348)

	return c.eventCh
}

func (c *roaClient) lifetimeout() {    fmt.Printf("DEJDEJ id:",349)
...
func (m *roaManager) HandleROAEvent(ev *ROAEvent) {    fmt.Printf("DEJDEJ id:",350)
...
func (m *roaManager) roa2tree(roa *table.ROA) (*radix.Tree, string) {    fmt.Printf("DEJDEJ id:",351)
...
func (m *roaManager) deleteROA(roa *table.ROA) {    fmt.Printf("DEJDEJ id:",352)
...
func (m *roaManager) DeleteROA(roa *table.ROA) {    fmt.Printf("DEJDEJ id:",353)

	m.deleteROA(roa)
}

func (m *roaManager) addROA(roa *table.ROA) {    fmt.Printf("DEJDEJ id:",354)
...
func (m *roaManager) AddROA(roa *table.ROA) {    fmt.Printf("DEJDEJ id:",355)

	m.addROA(roa)
}

func (c *roaManager) handleRTRMsg(client *roaClient, state *config.RpkiServerState, buf []byte) {    fmt.Printf("DEJDEJ id:",356)
...
func (c *roaManager) GetServers() []*config.RpkiServer {    fmt.Printf("DEJDEJ id:",357)
...
func (c *roaManager) GetRoa(family bgp.RouteFamily) ([]*table.ROA, error) {    fmt.Printf("DEJDEJ id:",358)
...
func ValidatePath(ownAs uint32, tree *radix.Tree, cidr string, asPath *bgp.PathAttributeAsPath) *table.Validation {    fmt.Printf("DEJDEJ id:",359)
...
func (c *roaManager) validate(pathList []*table.Path) {    fmt.Printf("DEJDEJ id:",360)
...
func NewRoaClient(address, port string, ch chan *ROAEvent, lifetime int64) *roaClient {    fmt.Printf("DEJDEJ id:",361)
...
func (c *roaClient) enable(serial uint32) error {    fmt.Printf("DEJDEJ id:",362)
...
func (c *roaClient) softReset() error {    fmt.Printf("DEJDEJ id:",363)
...
func (c *roaClient) reset() {    fmt.Printf("DEJDEJ id:",364)
...
func (c *roaClient) stop() {    fmt.Printf("DEJDEJ id:",365)

	c.cancelfnc()
	c.reset()
}

func (c *roaClient) tryConnect() {    fmt.Printf("DEJDEJ id:",366)
...
func (c *roaClient) established() (err error) {    fmt.Printf("DEJDEJ id:",367)
