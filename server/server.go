...
func (l *TCPListener) Close() error {    fmt.Printf("DEJDEJ id:",114)
...
func NewTCPListener(address string, port uint32, ch chan *net.TCPConn) (*TCPListener, error) {    fmt.Printf("DEJDEJ id:",115)
...
func NewBgpServer() *BgpServer {    fmt.Printf("DEJDEJ id:",116)
...
func (server *BgpServer) Listeners(addr string) []*net.TCPListener {    fmt.Printf("DEJDEJ id:",117)
...
func (s *BgpServer) active() error {    fmt.Printf("DEJDEJ id:",118)
...
func (server *BgpServer) handleMGMTOp(op *mgmtOp) {    fmt.Printf("DEJDEJ id:",119)
...
func (s *BgpServer) mgmtOperation(f func() error, checkActive bool) (err error) {    fmt.Printf("DEJDEJ id:",120)
...
func (server *BgpServer) Serve() {    fmt.Printf("DEJDEJ id:",121)
...
func (server *BgpServer) matchLongestDynamicNeighborPrefix(a string) *PeerGroup {    fmt.Printf("DEJDEJ id:",122)
...
func sendFsmOutgoingMsg(peer *Peer, paths []*table.Path, notification *bgp.BGPMessage, stayIdle bool) {    fmt.Printf("DEJDEJ id:",123)
...
func isASLoop(peer *Peer, path *table.Path) bool {    fmt.Printf("DEJDEJ id:",124)
...
func filterpath(peer *Peer, path, old *table.Path) *table.Path {    fmt.Printf("DEJDEJ id:",125)
...
func clonePathList(pathList []*table.Path) []*table.Path {    fmt.Printf("DEJDEJ id:",126)
...
func (server *BgpServer) notifyBestWatcher(best []*table.Path, multipath [][]*table.Path) {    fmt.Printf("DEJDEJ id:",127)
...
func (server *BgpServer) notifyPrePolicyUpdateWatcher(peer *Peer, pathList []*table.Path, msg *bgp.BGPMessage, timestamp time.Time, payload []byte) {    fmt.Printf("DEJDEJ id:",128)
...
func (server *BgpServer) notifyPostPolicyUpdateWatcher(peer *Peer, pathList []*table.Path) {    fmt.Printf("DEJDEJ id:",129)
...
func dstsToPaths(id string, dsts []*table.Destination, addpath bool) ([]*table.Path, []*table.Path, [][]*table.Path) {    fmt.Printf("DEJDEJ id:",130)
...
func (server *BgpServer) dropPeerAllRoutes(peer *Peer, families []bgp.RouteFamily) {    fmt.Printf("DEJDEJ id:",131)
...
func createWatchEventPeerState(peer *Peer) *WatchEventPeerState {    fmt.Printf("DEJDEJ id:",132)
...
func (server *BgpServer) broadcastPeerState(peer *Peer, oldState bgp.FSMState) {    fmt.Printf("DEJDEJ id:",133)
...
func (server *BgpServer) notifyMessageWatcher(peer *Peer, timestamp time.Time, msg *bgp.BGPMessage, isSent bool) {    fmt.Printf("DEJDEJ id:",134)
...
func (server *BgpServer) notifyRecvMessageWatcher(peer *Peer, timestamp time.Time, msg *bgp.BGPMessage) {    fmt.Printf("DEJDEJ id:",135)
...
func (server *BgpServer) RSimportPaths(peer *Peer, pathList []*table.Path) []*table.Path {    fmt.Printf("DEJDEJ id:",136)
...
func (server *BgpServer) propagateUpdate(peer *Peer, pathList []*table.Path) {    fmt.Printf("DEJDEJ id:",137)
...
func (server *BgpServer) propagateUpdateToNeighbors(peer *Peer, dsts []*table.Destination, gBestList, gOldList []*table.Path) {    fmt.Printf("DEJDEJ id:",138)
...
func (server *BgpServer) handleFSMMessage(peer *Peer, e *FsmMsg) {    fmt.Printf("DEJDEJ id:",139)
...
func (s *BgpServer) StartCollector(c *config.CollectorConfig) error {    fmt.Printf("DEJDEJ id:",140)
...
func (s *BgpServer) StartZebraClient(c *config.ZebraConfig) error {    fmt.Printf("DEJDEJ id:",141)
...
func (s *BgpServer) AddBmp(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",142)
...
func (s *BgpServer) DeleteBmp(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",143)
...
func (s *BgpServer) Shutdown() {    fmt.Printf("DEJDEJ id:",144)
...
func (s *BgpServer) UpdatePolicy(policy config.RoutingPolicy) error {    fmt.Printf("DEJDEJ id:",145)
...
func getMacMobilityExtendedCommunity(etag uint32, mac net.HardwareAddr, evpnPaths []*table.Path) *bgp.MacMobilityExtended {    fmt.Printf("DEJDEJ id:",146)
...
func (server *BgpServer) fixupApiPath(vrfId string, pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",147)
...
func (s *BgpServer) AddPath(vrfId string, pathList []*table.Path) (uuidBytes []byte, err error) {    fmt.Printf("DEJDEJ id:",148)
...
func (s *BgpServer) DeletePath(uuid []byte, f bgp.RouteFamily, vrfId string, pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",149)
...
func (s *BgpServer) UpdatePath(vrfId string, pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",150)
...
func (s *BgpServer) Start(c *config.Global) error {    fmt.Printf("DEJDEJ id:",151)
...
func (s *BgpServer) GetVrf() (l []*table.Vrf) {    fmt.Printf("DEJDEJ id:",152)
...
func (s *BgpServer) AddVrf(name string, id uint32, rd bgp.RouteDistinguisherInterface, im, ex []bgp.ExtendedCommunityInterface) error {    fmt.Printf("DEJDEJ id:",153)
...
func (s *BgpServer) DeleteVrf(name string) error {    fmt.Printf("DEJDEJ id:",154)
...
func (s *BgpServer) Stop() error {    fmt.Printf("DEJDEJ id:",155)
...
func (s *BgpServer) softResetIn(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",156)
...
func (s *BgpServer) softResetOut(addr string, family bgp.RouteFamily, deferral bool) error {    fmt.Printf("DEJDEJ id:",157)
...
func (s *BgpServer) SoftResetIn(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",158)
...
func (s *BgpServer) SoftResetOut(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",159)
...
func (s *BgpServer) SoftReset(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",160)
...
func (s *BgpServer) GetRib(addr string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (rib *table.Table, err error) {    fmt.Printf("DEJDEJ id:",161)
...
func (s *BgpServer) GetVrfRib(name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (rib *table.Table, err error) {    fmt.Printf("DEJDEJ id:",162)
...
func (s *BgpServer) GetAdjRib(addr string, family bgp.RouteFamily, in bool, prefixes []*table.LookupPrefix) (rib *table.Table, err error) {    fmt.Printf("DEJDEJ id:",163)
...
func (s *BgpServer) GetRibInfo(addr string, family bgp.RouteFamily) (info *table.TableInfo, err error) {    fmt.Printf("DEJDEJ id:",164)
...
func (s *BgpServer) GetAdjRibInfo(addr string, family bgp.RouteFamily, in bool) (info *table.TableInfo, err error) {    fmt.Printf("DEJDEJ id:",165)
...
func (s *BgpServer) GetServer() (c *config.Global) {    fmt.Printf("DEJDEJ id:",166)
...
func (s *BgpServer) GetNeighbor(address string, getAdvertised bool) (l []*config.Neighbor) {    fmt.Printf("DEJDEJ id:",167)
...
func (server *BgpServer) addPeerGroup(c *config.PeerGroup) error {    fmt.Printf("DEJDEJ id:",168)
...
func (server *BgpServer) addNeighbor(c *config.Neighbor) error {    fmt.Printf("DEJDEJ id:",169)
...
func (s *BgpServer) AddPeerGroup(c *config.PeerGroup) error {    fmt.Printf("DEJDEJ id:",170)
...
func (s *BgpServer) AddNeighbor(c *config.Neighbor) error {    fmt.Printf("DEJDEJ id:",171)
...
func (s *BgpServer) AddDynamicNeighbor(c *config.DynamicNeighbor) error {    fmt.Printf("DEJDEJ id:",172)
...
func (server *BgpServer) deletePeerGroup(pg *config.PeerGroup) error {    fmt.Printf("DEJDEJ id:",173)
...
func (server *BgpServer) deleteNeighbor(c *config.Neighbor, code, subcode uint8) error {    fmt.Printf("DEJDEJ id:",174)
...
func (s *BgpServer) DeletePeerGroup(c *config.PeerGroup) error {    fmt.Printf("DEJDEJ id:",175)
...
func (s *BgpServer) DeleteNeighbor(c *config.Neighbor) error {    fmt.Printf("DEJDEJ id:",176)
...
func (s *BgpServer) updatePeerGroup(pg *config.PeerGroup) (needsSoftResetIn bool, err error) {    fmt.Printf("DEJDEJ id:",177)
...
func (s *BgpServer) UpdatePeerGroup(pg *config.PeerGroup) (needsSoftResetIn bool, err error) {    fmt.Printf("DEJDEJ id:",178)
...
func (s *BgpServer) updateNeighbor(c *config.Neighbor) (needsSoftResetIn bool, err error) {    fmt.Printf("DEJDEJ id:",179)
...
func (s *BgpServer) UpdateNeighbor(c *config.Neighbor) (needsSoftResetIn bool, err error) {    fmt.Printf("DEJDEJ id:",180)
...
func (s *BgpServer) addrToPeers(addr string) (l []*Peer, err error) {    fmt.Printf("DEJDEJ id:",181)
...
func (s *BgpServer) resetNeighbor(op, addr string, subcode uint8, data []byte) error {    fmt.Printf("DEJDEJ id:",182)
...
func (s *BgpServer) ShutdownNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",183)
...
func (s *BgpServer) ResetNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",184)
...
func (s *BgpServer) setAdminState(addr, communication string, enable bool) error {    fmt.Printf("DEJDEJ id:",185)
...
func (s *BgpServer) EnableNeighbor(addr string) error {    fmt.Printf("DEJDEJ id:",186)
...
func (s *BgpServer) DisableNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",187)
...
func (s *BgpServer) GetDefinedSet(typ table.DefinedType, name string) (sets *config.DefinedSets, err error) {    fmt.Printf("DEJDEJ id:",188)
...
func (s *BgpServer) AddDefinedSet(a table.DefinedSet) error {    fmt.Printf("DEJDEJ id:",189)
...
func (s *BgpServer) DeleteDefinedSet(a table.DefinedSet, all bool) error {    fmt.Printf("DEJDEJ id:",190)
...
func (s *BgpServer) ReplaceDefinedSet(a table.DefinedSet) error {    fmt.Printf("DEJDEJ id:",191)
...
func (s *BgpServer) GetStatement() (l []*config.Statement) {    fmt.Printf("DEJDEJ id:",192)
...
func (s *BgpServer) AddStatement(st *table.Statement) error {    fmt.Printf("DEJDEJ id:",193)
...
func (s *BgpServer) DeleteStatement(st *table.Statement, all bool) error {    fmt.Printf("DEJDEJ id:",194)
...
func (s *BgpServer) ReplaceStatement(st *table.Statement) error {    fmt.Printf("DEJDEJ id:",195)
...
func (s *BgpServer) GetPolicy() (l []*config.PolicyDefinition) {    fmt.Printf("DEJDEJ id:",196)
...
func (s *BgpServer) AddPolicy(x *table.Policy, refer bool) error {    fmt.Printf("DEJDEJ id:",197)
...
func (s *BgpServer) DeletePolicy(x *table.Policy, all, preserve bool) error {    fmt.Printf("DEJDEJ id:",198)
...
func (s *BgpServer) ReplacePolicy(x *table.Policy, refer, preserve bool) error {    fmt.Printf("DEJDEJ id:",199)
...
func (server *BgpServer) toPolicyInfo(name string, dir table.PolicyDirection) (string, error) {    fmt.Printf("DEJDEJ id:",200)
...
func (s *BgpServer) GetPolicyAssignment(name string, dir table.PolicyDirection) (rt table.RouteType, l []*config.PolicyDefinition, err error) {    fmt.Printf("DEJDEJ id:",201)
...
func (s *BgpServer) AddPolicyAssignment(name string, dir table.PolicyDirection, policies []*config.PolicyDefinition, def table.RouteType) error {    fmt.Printf("DEJDEJ id:",202)
...
func (s *BgpServer) DeletePolicyAssignment(name string, dir table.PolicyDirection, policies []*config.PolicyDefinition, all bool) error {    fmt.Printf("DEJDEJ id:",203)
...
func (s *BgpServer) ReplacePolicyAssignment(name string, dir table.PolicyDirection, policies []*config.PolicyDefinition, def table.RouteType) error {    fmt.Printf("DEJDEJ id:",204)
...
func (s *BgpServer) EnableMrt(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",205)
...
func (s *BgpServer) DisableMrt(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",206)
...
func (s *BgpServer) ValidateRib(prefix string) error {    fmt.Printf("DEJDEJ id:",207)
...
func (s *BgpServer) GetRpki() (l []*config.RpkiServer, err error) {    fmt.Printf("DEJDEJ id:",208)
...
func (s *BgpServer) GetRoa(family bgp.RouteFamily) (l []*table.ROA, err error) {    fmt.Printf("DEJDEJ id:",209)
...
func (s *BgpServer) AddRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",210)
...
func (s *BgpServer) DeleteRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",211)
...
func (s *BgpServer) EnableRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",212)
...
func (s *BgpServer) DisableRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",213)
...
func (s *BgpServer) ResetRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",214)
...
func (s *BgpServer) SoftResetRpki(c *config.RpkiServerConfig) error {    fmt.Printf("DEJDEJ id:",215)
...
func WatchBestPath(current bool) WatchOption {    fmt.Printf("DEJDEJ id:",216)
...
func WatchUpdate(current bool) WatchOption {    fmt.Printf("DEJDEJ id:",217)
...
func WatchPostUpdate(current bool) WatchOption {    fmt.Printf("DEJDEJ id:",218)
...
func WatchPeerState(current bool) WatchOption {    fmt.Printf("DEJDEJ id:",219)
...
func WatchTableName(name string) WatchOption {    fmt.Printf("DEJDEJ id:",220)
...
func WatchMessage(isSent bool) WatchOption {    fmt.Printf("DEJDEJ id:",221)
...
func (w *Watcher) Event() <-chan WatchEvent {    fmt.Printf("DEJDEJ id:",222)

	return w.realCh
}

func (w *Watcher) Generate(t WatchEventType) error {    fmt.Printf("DEJDEJ id:",223)
...
func (w *Watcher) notify(v WatchEvent) {    fmt.Printf("DEJDEJ id:",224)

	w.ch.In() <- v
}

func (w *Watcher) loop() {    fmt.Printf("DEJDEJ id:",225)
...
func (w *Watcher) Stop() {    fmt.Printf("DEJDEJ id:",226)
...
func (s *BgpServer) isWatched(typ WatchEventType) bool {    fmt.Printf("DEJDEJ id:",227)

	return len(s.watcherMap[typ]) != 0
}

func (s *BgpServer) notifyWatcher(typ WatchEventType, ev WatchEvent) {    fmt.Printf("DEJDEJ id:",228)
...
func (s *BgpServer) Watch(opts ...WatchOption) (w *Watcher) {    fmt.Printf("DEJDEJ id:",229)
