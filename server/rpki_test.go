...
func strToASParam(str string) *bgp.PathAttributeAsPath {    fmt.Printf("DEJDEJ id:",66)
...
func validateOne(tree *radix.Tree, cidr, aspathStr string) config.RpkiValidationResultType {    fmt.Printf("DEJDEJ id:",67)

	r := ValidatePath(65500, tree, cidr, strToASParam(aspathStr))
	return r.Status
}

func TestValidate0(t *testing.T) {    fmt.Printf("DEJDEJ id:",68)
...
func TestValidate1(t *testing.T) {    fmt.Printf("DEJDEJ id:",69)
...
func TestValidate2(t *testing.T) {    fmt.Printf("DEJDEJ id:",70)
...
func TestValidate3(t *testing.T) {    fmt.Printf("DEJDEJ id:",71)
...
func TestValidate4(t *testing.T) {    fmt.Printf("DEJDEJ id:",72)
...
func TestValidate5(t *testing.T) {    fmt.Printf("DEJDEJ id:",73)
...
func TestValidate6(t *testing.T) {    fmt.Printf("DEJDEJ id:",74)
...
func TestValidate7(t *testing.T) {    fmt.Printf("DEJDEJ id:",75)
...
func TestValidate8(t *testing.T) {    fmt.Printf("DEJDEJ id:",76)
...
func TestValidate9(t *testing.T) {    fmt.Printf("DEJDEJ id:",77)
...
func TestValidate10(t *testing.T) {    fmt.Printf("DEJDEJ id:",78)
