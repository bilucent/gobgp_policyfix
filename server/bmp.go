...
func newribout() ribout {    fmt.Printf("DEJDEJ id:",5)

	return make(map[string][]*table.Path)
}

// return true if we need to send the path to the BMP server
func (r ribout) update(p *table.Path) bool {    fmt.Printf("DEJDEJ id:",6)
...
func (b *bmpClient) tryConnect() *net.TCPConn {    fmt.Printf("DEJDEJ id:",7)
...
func (b *bmpClient) Stop() {    fmt.Printf("DEJDEJ id:",8)

	close(b.dead)
}

func (b *bmpClient) loop() {    fmt.Printf("DEJDEJ id:",9)
...
func bmpPeerUp(laddr string, lport, rport uint16, sent, recv *bgp.BGPMessage, t uint8, policy bool, pd uint64, peeri *table.PeerInfo, timestamp int64) *bmp.BMPMessage {    fmt.Printf("DEJDEJ id:",10)
...
func bmpPeerDown(reason uint8, t uint8, policy bool, pd uint64, peeri *table.PeerInfo, timestamp int64) *bmp.BMPMessage {    fmt.Printf("DEJDEJ id:",11)
...
func bmpPeerRoute(t uint8, policy bool, pd uint64, fourBytesAs bool, peeri *table.PeerInfo, timestamp int64, payload []byte) *bmp.BMPMessage {    fmt.Printf("DEJDEJ id:",12)
...
func bmpPeerStats(peerType uint8, peerDist uint64, timestamp int64, neighConf *config.Neighbor) *bmp.BMPMessage {    fmt.Printf("DEJDEJ id:",13)
...
func bmpPeerRouteMirroring(peerType uint8, peerDist uint64, peerInfo *table.PeerInfo, timestamp int64, msg *bgp.BGPMessage) *bmp.BMPMessage {    fmt.Printf("DEJDEJ id:",14)
...
func (b *bmpClientManager) addServer(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",15)
...
func (b *bmpClientManager) deleteServer(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",16)
...
func newBmpClientManager(s *BgpServer) *bmpClientManager {    fmt.Printf("DEJDEJ id:",17)
