...
func buildTcpMD5Sig(address string, key string) (tcpmd5sig, error) {    fmt.Printf("DEJDEJ id:",250)
...
func setsockoptTcpMD5Sig(fd int, address string, key string) error {    fmt.Printf("DEJDEJ id:",251)
...
func SetTcpMD5SigSockopt(l *net.TCPListener, address string, key string) error {    fmt.Printf("DEJDEJ id:",252)
...
func setsockoptIpTtl(fd int, family int, value int) error {    fmt.Printf("DEJDEJ id:",253)
...
func SetListenTcpTTLSockopt(l *net.TCPListener, ttl int) error {    fmt.Printf("DEJDEJ id:",254)
...
func SetTcpTTLSockopt(conn *net.TCPConn, ttl int) error {    fmt.Printf("DEJDEJ id:",255)
...
func setsockoptIpMinTtl(fd int, family int, value int) error {    fmt.Printf("DEJDEJ id:",256)
...
func SetTcpMinTTLSockopt(conn *net.TCPConn, ttl int) error {    fmt.Printf("DEJDEJ id:",257)
...
func (d *TCPDialer) DialTCP(addr string, port int) (*net.TCPConn, error) {    fmt.Printf("DEJDEJ id:",258)
