...
func defaultGRPCOptions() []grpc.DialOption {    fmt.Printf("DEJDEJ id:",1729)
...
// Client will be nil.
func New(target string, opts ...grpc.DialOption) (*Client, error) {    fmt.Printf("DEJDEJ id:",1730)
...
func NewWith(ctx context.Context, target string, opts ...grpc.DialOption) (*Client, error) {    fmt.Printf("DEJDEJ id:",1731)
...
// dialed for you.
func NewFrom(conn *grpc.ClientConn, cli api.GobgpApiClient) *Client {    fmt.Printf("DEJDEJ id:",1732)

	return &Client{conn: conn, cli: cli}
}

func (cli *Client) Close() error {    fmt.Printf("DEJDEJ id:",1733)

	return cli.conn.Close()
}

func (cli *Client) StartServer(c *config.Global) error {    fmt.Printf("DEJDEJ id:",1734)
...
func (cli *Client) StopServer() error {    fmt.Printf("DEJDEJ id:",1735)

	_, err := cli.cli.StopServer(context.Background(), &api.StopServerRequest{})
	return err
}

func (cli *Client) GetServer() (*config.Global, error) {    fmt.Printf("DEJDEJ id:",1736)
...
func (cli *Client) EnableZebra(c *config.Zebra) error {    fmt.Printf("DEJDEJ id:",1737)
...
func (cli *Client) getNeighbor(name string, afi int, vrf string, enableAdvertised bool) ([]*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1738)
...
func (cli *Client) ListNeighbor() ([]*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1739)

	return cli.getNeighbor("", 0, "", false)
}

func (cli *Client) ListNeighborByTransport(afi int) ([]*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1740)

	return cli.getNeighbor("", afi, "", false)
}

func (cli *Client) ListNeighborByVRF(vrf string) ([]*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1741)

	return cli.getNeighbor("", 0, vrf, false)
}

func (cli *Client) GetNeighbor(name string, options ...bool) (*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1742)
...
func (cli *Client) AddNeighbor(c *config.Neighbor) error {    fmt.Printf("DEJDEJ id:",1743)
...
func (cli *Client) DeleteNeighbor(c *config.Neighbor) error {    fmt.Printf("DEJDEJ id:",1744)
...
//func (cli *Client) UpdateNeighbor(c *config.Neighbor) (bool, error) {    fmt.Printf("DEJDEJ id:",1745)

//}

func (cli *Client) ShutdownNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",1746)

	_, err := cli.cli.ShutdownNeighbor(context.Background(), &api.ShutdownNeighborRequest{Address: addr, Communication: communication})
	return err
}

func (cli *Client) ResetNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",1747)

	_, err := cli.cli.ResetNeighbor(context.Background(), &api.ResetNeighborRequest{Address: addr, Communication: communication})
	return err
}

func (cli *Client) EnableNeighbor(addr string) error {    fmt.Printf("DEJDEJ id:",1748)

	_, err := cli.cli.EnableNeighbor(context.Background(), &api.EnableNeighborRequest{Address: addr})
	return err
}

func (cli *Client) DisableNeighbor(addr, communication string) error {    fmt.Printf("DEJDEJ id:",1749)

	_, err := cli.cli.DisableNeighbor(context.Background(), &api.DisableNeighborRequest{Address: addr, Communication: communication})
	return err
}

func (cli *Client) softreset(addr string, family bgp.RouteFamily, dir api.SoftResetNeighborRequest_SoftResetDirection) error {    fmt.Printf("DEJDEJ id:",1750)
...
func (cli *Client) SoftResetIn(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",1751)

	return cli.softreset(addr, family, api.SoftResetNeighborRequest_IN)
}

func (cli *Client) SoftResetOut(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",1752)

	return cli.softreset(addr, family, api.SoftResetNeighborRequest_OUT)
}

func (cli *Client) SoftReset(addr string, family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",1753)

	return cli.softreset(addr, family, api.SoftResetNeighborRequest_BOTH)
}

func (cli *Client) getRIB(resource api.Resource, name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1754)
...
func (cli *Client) GetRIB(family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1755)

	return cli.getRIB(api.Resource_GLOBAL, "", family, prefixes)
}

func (cli *Client) GetLocalRIB(name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1756)

	return cli.getRIB(api.Resource_LOCAL, name, family, prefixes)
}

func (cli *Client) GetAdjRIBIn(name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1757)

	return cli.getRIB(api.Resource_ADJ_IN, name, family, prefixes)
}

func (cli *Client) GetAdjRIBOut(name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1758)

	return cli.getRIB(api.Resource_ADJ_OUT, name, family, prefixes)
}

func (cli *Client) GetVRFRIB(name string, family bgp.RouteFamily, prefixes []*table.LookupPrefix) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1759)

	return cli.getRIB(api.Resource_VRF, name, family, prefixes)
}

func (cli *Client) getRIBInfo(resource api.Resource, name string, family bgp.RouteFamily) (*table.TableInfo, error) {    fmt.Printf("DEJDEJ id:",1760)
...
func (cli *Client) GetRIBInfo(family bgp.RouteFamily) (*table.TableInfo, error) {    fmt.Printf("DEJDEJ id:",1761)

	return cli.getRIBInfo(api.Resource_GLOBAL, "", family)
}

func (cli *Client) GetLocalRIBInfo(name string, family bgp.RouteFamily) (*table.TableInfo, error) {    fmt.Printf("DEJDEJ id:",1762)

	return cli.getRIBInfo(api.Resource_LOCAL, name, family)
}

func (cli *Client) GetAdjRIBInInfo(name string, family bgp.RouteFamily) (*table.TableInfo, error) {    fmt.Printf("DEJDEJ id:",1763)

	return cli.getRIBInfo(api.Resource_ADJ_IN, name, family)
}

func (cli *Client) GetAdjRIBOutInfo(name string, family bgp.RouteFamily) (*table.TableInfo, error) {    fmt.Printf("DEJDEJ id:",1764)
...
func (c *AddPathByStreamClient) Send(paths ...*table.Path) error {    fmt.Printf("DEJDEJ id:",1765)
...
func (c *AddPathByStreamClient) Close() error {    fmt.Printf("DEJDEJ id:",1766)

	_, err := c.stream.CloseAndRecv()
	return err
}

func (cli *Client) AddPathByStream() (*AddPathByStreamClient, error) {    fmt.Printf("DEJDEJ id:",1767)
...
func (cli *Client) addPath(vrfID string, pathList []*table.Path) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1768)
...
func (cli *Client) AddPath(pathList []*table.Path) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1769)

	return cli.addPath("", pathList)
}

func (cli *Client) AddVRFPath(vrfID string, pathList []*table.Path) ([]byte, error) {    fmt.Printf("DEJDEJ id:",1770)
...
func (cli *Client) deletePath(uuid []byte, f bgp.RouteFamily, vrfID string, pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",1771)
...
func (cli *Client) DeletePath(pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",1772)

	return cli.deletePath(nil, bgp.RouteFamily(0), "", pathList)
}

func (cli *Client) DeleteVRFPath(vrfID string, pathList []*table.Path) error {    fmt.Printf("DEJDEJ id:",1773)
...
func (cli *Client) DeletePathByUUID(uuid []byte) error {    fmt.Printf("DEJDEJ id:",1774)

	return cli.deletePath(uuid, bgp.RouteFamily(0), "", nil)
}

func (cli *Client) DeletePathByFamily(family bgp.RouteFamily) error {    fmt.Printf("DEJDEJ id:",1775)

	return cli.deletePath(nil, family, "", nil)
}

func (cli *Client) GetVRF() ([]*table.Vrf, error) {    fmt.Printf("DEJDEJ id:",1776)
...
func (cli *Client) AddVRF(name string, id int, rd bgp.RouteDistinguisherInterface, im, ex []bgp.ExtendedCommunityInterface) error {    fmt.Printf("DEJDEJ id:",1777)
...
func (cli *Client) DeleteVRF(name string) error {    fmt.Printf("DEJDEJ id:",1778)
...
func (cli *Client) getDefinedSet(typ table.DefinedType, name string) ([]table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",1779)
...
func (cli *Client) GetDefinedSet(typ table.DefinedType) ([]table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",1780)

	return cli.getDefinedSet(typ, "")
}

func (cli *Client) GetDefinedSetByName(typ table.DefinedType, name string) (table.DefinedSet, error) {    fmt.Printf("DEJDEJ id:",1781)
...
func (cli *Client) AddDefinedSet(d table.DefinedSet) error {    fmt.Printf("DEJDEJ id:",1782)
...
func (cli *Client) DeleteDefinedSet(d table.DefinedSet, all bool) error {    fmt.Printf("DEJDEJ id:",1783)
...
func (cli *Client) ReplaceDefinedSet(d table.DefinedSet) error {    fmt.Printf("DEJDEJ id:",1784)
...
func (cli *Client) GetStatement() ([]*table.Statement, error) {    fmt.Printf("DEJDEJ id:",1785)
...
func (cli *Client) AddStatement(t *table.Statement) error {    fmt.Printf("DEJDEJ id:",1786)
...
func (cli *Client) DeleteStatement(t *table.Statement, all bool) error {    fmt.Printf("DEJDEJ id:",1787)
...
func (cli *Client) ReplaceStatement(t *table.Statement) error {    fmt.Printf("DEJDEJ id:",1788)
...
func (cli *Client) GetPolicy() ([]*table.Policy, error) {    fmt.Printf("DEJDEJ id:",1789)
...
func (cli *Client) AddPolicy(t *table.Policy, refer bool) error {    fmt.Printf("DEJDEJ id:",1790)
...
func (cli *Client) DeletePolicy(t *table.Policy, all, preserve bool) error {    fmt.Printf("DEJDEJ id:",1791)
...
func (cli *Client) ReplacePolicy(t *table.Policy, refer, preserve bool) error {    fmt.Printf("DEJDEJ id:",1792)
...
func (cli *Client) getPolicyAssignment(name string, dir table.PolicyDirection) (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1793)
...
func (cli *Client) GetImportPolicy() (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1794)

	return cli.getPolicyAssignment("", table.POLICY_DIRECTION_IMPORT)
}

func (cli *Client) GetExportPolicy() (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1795)

	return cli.getPolicyAssignment("", table.POLICY_DIRECTION_EXPORT)
}

func (cli *Client) GetRouteServerInPolicy(name string) (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1796)

	return cli.getPolicyAssignment(name, table.POLICY_DIRECTION_IN)
}

func (cli *Client) GetRouteServerImportPolicy(name string) (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1797)

	return cli.getPolicyAssignment(name, table.POLICY_DIRECTION_IMPORT)
}

func (cli *Client) GetRouteServerExportPolicy(name string) (*table.PolicyAssignment, error) {    fmt.Printf("DEJDEJ id:",1798)

	return cli.getPolicyAssignment(name, table.POLICY_DIRECTION_EXPORT)
}

func (cli *Client) AddPolicyAssignment(assignment *table.PolicyAssignment) error {    fmt.Printf("DEJDEJ id:",1799)
...
func (cli *Client) DeletePolicyAssignment(assignment *table.PolicyAssignment, all bool) error {    fmt.Printf("DEJDEJ id:",1800)
...
func (cli *Client) ReplacePolicyAssignment(assignment *table.PolicyAssignment) error {    fmt.Printf("DEJDEJ id:",1801)
...
//func (cli *Client) EnableMrt(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",1802)

//}
//
//func (cli *Client) DisableMrt(c *config.MrtConfig) error {    fmt.Printf("DEJDEJ id:",1803)

//}
//

func (cli *Client) GetRPKI() ([]*config.RpkiServer, error) {    fmt.Printf("DEJDEJ id:",1804)
...
func (cli *Client) GetROA(family bgp.RouteFamily) ([]*table.ROA, error) {    fmt.Printf("DEJDEJ id:",1805)
...
func (cli *Client) AddRPKIServer(address string, port, lifetime int) error {    fmt.Printf("DEJDEJ id:",1806)
...
func (cli *Client) DeleteRPKIServer(address string) error {    fmt.Printf("DEJDEJ id:",1807)
...
func (cli *Client) EnableRPKIServer(address string) error {    fmt.Printf("DEJDEJ id:",1808)
...
func (cli *Client) DisableRPKIServer(address string) error {    fmt.Printf("DEJDEJ id:",1809)
...
func (cli *Client) ResetRPKIServer(address string) error {    fmt.Printf("DEJDEJ id:",1810)
...
func (cli *Client) SoftResetRPKIServer(address string) error {    fmt.Printf("DEJDEJ id:",1811)
...
func (cli *Client) ValidateRIBWithRPKI(prefixes ...string) error {    fmt.Printf("DEJDEJ id:",1812)
...
func (cli *Client) AddBMP(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",1813)
...
func (cli *Client) DeleteBMP(c *config.BmpServerConfig) error {    fmt.Printf("DEJDEJ id:",1814)
...
func (c *MonitorRIBClient) Recv() (*table.Destination, error) {    fmt.Printf("DEJDEJ id:",1815)
...
func (cli *Client) MonitorRIB(family bgp.RouteFamily, current bool) (*MonitorRIBClient, error) {    fmt.Printf("DEJDEJ id:",1816)
...
func (cli *Client) MonitorAdjRIBIn(name string, family bgp.RouteFamily, current bool) (*MonitorRIBClient, error) {    fmt.Printf("DEJDEJ id:",1817)
...
func (c *MonitorNeighborStateClient) Recv() (*config.Neighbor, error) {    fmt.Printf("DEJDEJ id:",1818)
...
func (cli *Client) MonitorNeighborState(name string, current bool) (*MonitorNeighborStateClient, error) {    fmt.Printf("DEJDEJ id:",1819)
