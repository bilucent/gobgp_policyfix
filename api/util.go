...
func (t *Table) ToNativeTable(option ...ToNativeOption) (*table.Table, error) {    fmt.Printf("DEJDEJ id:",1721)
...
func getNLRI(family bgp.RouteFamily, buf []byte) (bgp.AddrPrefixInterface, error) {    fmt.Printf("DEJDEJ id:",1722)
...
func (d *Destination) ToNativeDestination(option ...ToNativeOption) (*table.Destination, error) {    fmt.Printf("DEJDEJ id:",1723)
...
func (p *Path) GetNativeNlri() (bgp.AddrPrefixInterface, error) {    fmt.Printf("DEJDEJ id:",1724)

	return getNLRI(bgp.RouteFamily(p.Family), p.Nlri)
}

func (p *Path) ToNativePath(option ...ToNativeOption) (*table.Path, error) {    fmt.Printf("DEJDEJ id:",1725)
...
func NewROAListFromApiStructList(l []*Roa) []*table.ROA {    fmt.Printf("DEJDEJ id:",1726)
...
func extractFamilyFromConfigAfiSafi(c *config.AfiSafi) uint32 {    fmt.Printf("DEJDEJ id:",1727)
