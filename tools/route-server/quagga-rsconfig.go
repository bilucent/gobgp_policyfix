...
func NewQuaggaConfig(id int, gConfig *config.Global, myConfig *config.Neighbor, server net.IP) *QuaggaConfig {    fmt.Printf("DEJDEJ id:",3700)
...
func (qt *QuaggaConfig) Config() *bytes.Buffer {    fmt.Printf("DEJDEJ id:",3701)
...
func create_config_files(nr int, outputDir string) {    fmt.Printf("DEJDEJ id:",3702)
...
func main() {    fmt.Printf("DEJDEJ id:",3703)
